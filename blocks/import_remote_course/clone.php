...
if ($fromform = $mform->get_data()) {
     ...
     $originalcoursetamplate = $DB->get_record('import_remote_course_templat', ['course_id' => $originalcourse]);
     $originalcoursetamplate = course_template::get_record(['course_id' => $originalcourse]);

    if (! $originalcoursetamplate) {
    ...
    if ($rc->execute_precheck()) {
         ...
         $dataobject->tamplate_id = $originalcoursetamplate->get('tamplate_id');
