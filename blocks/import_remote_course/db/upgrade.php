...
function xmldb_block_import_remote_course_upgrade($oldversion) {
    ...
    if ($oldversion < 2017100604) {
    	...
    	upgrade_plugin_savepoint(true, 2017100604, 'block', 'import_remote_course');
    ...
    if ($oldversion < 2017111300) {
    	...
    	if (!$dbman->table_exists($table)) {
    		$dbman->install_one_table_from_xmldb_file($CFG->dirroot . '/blocks/import_remote_course/db/install.xml', 'import_remote_course_notific');
    	}
    	...
    	upgrade_plugin_savepoint(true, 2017111300, 'block', 'import_remote_course');
    ...
    if ($oldversion < 2017111401) {
    	...
    	upgrade_plugin_savepoint(true, 2017111401, 'block', 'import_remote_course');
