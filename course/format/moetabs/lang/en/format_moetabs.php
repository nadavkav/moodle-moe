...
$string['moetabspagesectionone'] = '<h1 class="moetabs multilang" lang="he">Section 1</h1><h1 class="moetabs multilang" lang="en">Section 1</h1>';
$string['moetabspagesectiontwo'] = '<h1 class="moetabs multilang" lang="he">Section 2</h1><h1 class="moetabs multilang" lang="en">Section 2</h1>';
$string['moetabspagesectionthree'] = '<h1 class="moetabs multilang" lang="he">Section 3</h1><h1 class="moetabs multilang" lang="en">Section 3</h1>';
