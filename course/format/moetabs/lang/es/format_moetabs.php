...
/**
 * Strings for component 'format_moetabs', language 'es', branch 'MOODLE_24_STABLE'
 *
 * @since 2.4
...
$string['pluginname'] = 'Moe tabs format';
$string['sectionname'] = 'Tema';
$string['page-course-view-topics'] = 'Alguna página principal de curso en formato moetabs';
$string['page-course-view-topics-x'] = 'Alguna página de curso en formato moetabs';
