...
/**
 * Strings for component 'format_moetabs', language 'en', branch 'MOODLE_24_STABLE'
 *
 * @since 2.4
...
$string['page-course-view-topics'] = 'Any course main page in moetabs format';
$string['page-course-view-topics-x'] = 'Any course page in moetabs format';
