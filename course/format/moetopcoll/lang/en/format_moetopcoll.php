...
$string['pluginname'] = 'Collapsed Topics MOE';
$string['section0name'] = 'General';

// MDL-26105.
$string['page-course-view-moetopcoll'] = 'Any course main page in the collapsed topics format';
$string['page-course-view-moetopcoll-x'] = 'Any course page in the collapsed topics format';
...
// Capabilities.
$string['moetopcoll:changelayout'] = 'Change or reset the layout';
$string['moetopcoll:changecolour'] = 'Change or reset the colour';
$string['moetopcoll:changetogglealignment'] = 'Change or reset the toggle alignment';
$string['moetopcoll:changetoggleiconset'] = 'Change or reset the toggle icon set';
