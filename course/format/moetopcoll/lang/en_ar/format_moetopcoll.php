...
// Capabilities.
$string['moetopcoll:changelayout'] = 'Change or reset thee layout';
$string['moetopcoll:changecolour'] = 'Change or reset thee colour';
$string['moetopcoll:changetogglealignment'] = 'Change or reset thee toggle alignment';
$string['moetopcoll:changetoggleiconset'] = 'Change or reset thee toggle icon set';
