...
require_once($CFG->dirroot . '/course/format/moetopcoll/togglelib.php');

class format_moetopcoll_renderer extends format_section_renderer_base {
    ...
    public function __construct(moodle_page $page, $target) {
        ...
        $this->tctoggleiconsize = clean_param(get_config('format_moetopcoll', 'defaulttoggleiconsize'), PARAM_TEXT);
        $this->formatresponsive = get_config('format_moetopcoll', 'formatresponsive');
                ...
                switch ($this->tcsettings['layoutelement']) { // Toggle section x.
                    ...
                    case 8:
                        ...
                        if (($this->tcsettings['layoutstructure'] == 1) || ($this->tcsettings['layoutstructure'] == 4)) {
                            $topictext = get_string('setlayoutstructuretopic', 'format_moetopcoll');
                        } else if (($this->tcsettings['layoutstructure'] == 2) || ($this->tcsettings['layoutstructure'] == 3)) {
                            $topictext = get_string('setlayoutstructureweek', 'format_moetopcoll');
                        } else {
                            $topictext = get_string('setlayoutstructureday', 'format_moetopcoll');
                        }
    ...
    protected function section_edit_control_items($course, $section, $onsectionpage = false) {
        ...
        if ((($this->tcsettings['layoutstructure'] == 1) || ($this->tcsettings['layoutstructure'] == 4)) &&
            ...
            if ($course->marker == $section->section) {  // Show the "light globe" on/off.
                $url->param('marker', 0);
                $markedthissection = get_string('markedthissection', 'format_moetopcoll');
                ...
                $markthissection = get_string('markthissection', 'format_moetopcoll');
    ...
    protected function section_summary($section, $course, $mods) {
        ...
        $o = '';
        $title = $this->courseformat->get_moetopcoll_section_name($course, $section, false);
        $liattributes = array(
    ...
    protected function section_header($section, $course, $onsectionpage, $sectionreturn = null) {
        ...
        $liattributes = array(
            ...
            'role' => 'region',
            'aria-label' => $this->courseformat->get_moetopcoll_section_name($course, $section, false)
        );
        if (($this->formatresponsive) && ($this->tcsettings['layoutcolumnorientation'] == 2)) { // Horizontal column layout.
            $liattributes['style'] = 'width: ' . $this->tccolumnwidth . '%;';
        }
            ...
            if (($section->section != 0) && $this->userisediting && has_capability('moodle/course:update', $context)) {
                ...
                $rightcontent .= html_writer::link($url,
                    html_writer::empty_tag('img',
                        ...
                        array('title' => get_string('editsection', 'format_moetopcoll'), 'class' => 'tceditsection'));
            }
        ...
        if (($onsectionpage == false) && ($section->section != 0)) {
            ...
            if ($this->userisediting) {
                ...
                $title = $this->courseformat->get_moetopcoll_section_name($course, $section, true);
            }
            if ((($this->mobiletheme === false) && ($this->tablettheme === false)) || ($this->userisediting)) {
            ...
            if ($this->userisediting && has_capability('moodle/course:update', $context)) {
                ...
                $o .= html_writer::link($url,
                    html_writer::empty_tag('img',
                        ...
                        array('title' => get_string('editsection', 'format_moetopcoll'))
                );
            }
    ...
    protected function stealth_section_header($sectionno) {
        ...
        $liattributes = array(
            ...
            'role' => 'region',
            'aria-label' => $this->courseformat->get_moetopcoll_section_name($course, $sectionno, false)
        );
        if (($this->formatresponsive) && ($this->tcsettings['layoutcolumnorientation'] == 2)) { // Horizontal column layout.
            $liattributes['style'] = 'width: ' . $this->tccolumnwidth . '%;';
        }
        ...
        if ($course->numsections > 0) {
            ...
            if (($this->tcsettings['layoutcolumns'] > 1) && ($this->mobiletheme === false)) {
                if ($this->tcsettings['layoutcolumns'] > 4) {
                    ...
                    // Update....
                    $this->courseformat->update_moetopcoll_columns_setting($this->tcsettings['layoutcolumns']);
                }
    ...
    protected function toggle_all() {
        ...
        $o .= html_writer::tag('span', get_string('topcollopened', 'format_moetopcoll'),
            array('class' => 'on ' . $this->tctoggleiconsize, 'id' => 'toggles-all-opened',
            'role' => 'button')
        );
        $o .= html_writer::tag('span', get_string('topcollclosed', 'format_moetopcoll'),
    ...
    protected function display_instructions() {
        $o = html_writer::start_tag('li',
            array('class' => 'tcsection main clearfix', 'id' => 'moetopcoll-display-instructions'));
        ...
        $o .= html_writer::tag('p', get_string('instructions', 'format_moetopcoll'),
            array('class' => 'moetopcoll-display-instructions')
        );
        $o .= html_writer::end_tag('div');
        $o .= html_writer::end_tag('div');
        $o .= html_writer::end_tag('li');
