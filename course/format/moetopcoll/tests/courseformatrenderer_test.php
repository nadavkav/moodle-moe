 ...
 * @group format_moetopcoll
 */
class format_moetopcoll_courseformatrenderer_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        global $PAGE;
        $this->outputus = $PAGE->get_renderer('format_moetopcoll');
        // Ref: https://docs.moodle.org/dev/Writing_PHPUnit_tests.
        $this->course = $this->getDataGenerator()->create_course(array('format' => 'moetopcoll', 'numsections' => 1),
    ...
    public function test_display_instructions() {
        ...
        $thevalue = '<li class="tcsection main clearfix" id="moetopcoll-display-instructions"><div class="left side">';
        ...
        $thevalue .= '<img width="1" height="1" class="spacer" alt="" src="';
        $thevalue .= 'http://www.example.com/moodle/theme/image.php/_s/clean/core/1/spacer" /></div><div class="content">';
        $thevalue .= '<div class="sectionbody"><p class="moetopcoll-display-instructions">Instructions: Clicking on the section ';
