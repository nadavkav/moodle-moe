...
$url = new moodle_url('/local/moereports/view.php');
...
$PAGE->set_title(get_string('reports', 'local_moereports'));
$PAGE->set_heading(get_string('reports', 'local_moereports'));
$PAGE->set_pagelayout('admin');

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('reports', 'local_moereports'));
