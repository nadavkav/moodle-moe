...
certificate_print_text($pdf, $x, $y + 20, 'C', $fontserif, '', 15, get_string('certify', 'certificate'));
certificate_print_text($pdf, $x, $y + 36, 'C', $fontsans, '', 30, fullname($USER));
certificate_print_text($pdf, $x, $y + 55, 'C', $fontsans, '', 15, get_string('statement', 'certificate'));
