...
module.exports = "button{box-shadow:none;}" +
		...
		".annotator-viewer .annotator-item{border:1px solid #b6b7b2}" +
		".annotator-editor .annotator-item,.annotator-viewer div{border-top:1px solid #858585;border-top:1px solid rgba(133,133,133,.11)}.annotator-viewer div{padding:6px}.annotator-viewer .annotator-item ol,.annotator-viewer .annotator-item ul{padding:4px 16px}" +
...
var Viewer = exports.Viewer = Widget.extend({
    ...
    constructor: function (options) {
        ...
        if (this.options.defaultFields) {
            this.addField({
                load: function (field, annotation) {
                	$(field).parent().prepend('<div class="annotator-item_part text span6"><span>' +self.render(annotation)+ '</span></div>');
                	$(field).parent().prepend('<div class="annotator-item_part image span2"><img src="' + annotation.userpicture +'" class="anottatepicture"/></div>');
                	/*$(field).parent().append('<div class="clearfix"></div>');*/
                }
            });
        }
...
Viewer.itemTemplate = [
    ...
    '  <div class="annotator-controls span2">',
    '    <a href="#"',
