...
var Viewer = exports.Viewer = Widget.extend({
    ...
    _onHighlightClick: function (event){
    	if (this.mouseDown) {
            return;
        }
        ...
        this.adder.onCreate({
        	quote:this.annotations[this.annotations.length-1].quote,
        	ranges: this.annotations[this.annotations.length-1].ranges
        });
    },
