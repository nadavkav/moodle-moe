...
if (core_text::strlen($pagename) > 200) {
    print_error('pagenametoolong', 'moewiki');
}
// Convert nbsp to space
$pagename = str_replace(html_entity_decode('&nbsp;', ENT_QUOTES, 'UTF-8'), ' ', $pagename);
$pagename = trim($pagename);
if (strtolower($pagename) == strtolower(get_string('startpage', 'moewiki'))) {
    print_error('pagenameisstartpage', 'moewiki');
}
