...
class page_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event:moewikipagecreated', 'mod_moewiki');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the page {$this->other['info']} with id '$this->objectid'
                for the moewiki with course module id of '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'moewiki', 'page created', $logurl,
