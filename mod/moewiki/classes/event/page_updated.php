...
class page_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event:moewikipageupdated', 'mod_moewiki');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the page {$this->other['info']} with id '$this->objectid'
                for the moewiki with the course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        $logurl = substr($this->other['logurl'], strlen('/mod/moewiki/'));
        return array($this->courseid, 'moewiki', 'page updated', $logurl,
