...
if ($hide) {
    set_user_preference(MOEWIKI_PREF_HIDEANNOTATIONS, 1);
} else {
    unset_user_preference(MOEWIKI_PREF_HIDEANNOTATIONS);
}
...
redirect('view.php?' .moewiki_display_wiki_parameters(
        $pagename, $subwiki, $cm, MOEWIKI_PARAMS_URL));
