...
$string['nogroups'] = 'This wiki cannot be displayed because it is a group wiki, but no groups have been set up for the course (or grouping, if selected).';
$string['nogroupsaccess'] = 'You do not have access to any of the groups in this wiki.';
...
$string['moewiki:addinstance'] = 'Add a new MOE wiki';
$string['moewiki:edit']='Edit wiki pages';
$string['moewiki:view']='View wikis';
$string['moewiki:overridelock']='Override locked pages';
...
$string['moewiki:viewcontributions']='View list of contributions organised by user';
$string['moewiki:deletepage'] = 'Delete wiki pages';
$string['moewiki:viewparticipation'] = 'View participation of all enrolled users who have access to wiki';
$string['moewiki:grade'] = 'Grade users who have have access to wiki';
$string['moewiki:editothers'] = 'Edit the content of any sub-wiki that can be viewed';
$string['moewiki:annotateothers'] = 'Annotate any sub-wiki that can be viewed';
...
$string['displayversion'] = 'MOE wiki version: <strong>{$a}</strong>';
...
$string['event:moewikiviewed'] = 'moewiki view';
$string['event:pageunlock'] = 'moewiki unlock';
$string['event:pagelock'] = 'moewiki lock';
$string['event:moewikiundelete'] = 'moewiki version undelete';
$string['event:moewikidelete'] = 'moewiki version delete';
$string['event:moewikipagecreated'] = 'moewiki page created';
