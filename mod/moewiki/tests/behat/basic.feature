@ou @ou_vle @mod @mod_moewiki @moewiki_basic
Feature: Test Post and Comment on MOEwiki entry
  In order to use moewiki features
  As a user
  ...
  Scenario: No groups - basic access etc
    ...
    When I add a "MOE wiki" to section "1" and I fill the form with:
        | Name | W.WC |
    ...
    Then I should see "C1 no groups wiki" in the ".moewiki_content" "css_element"
    ...
    Then I should see "C7 no groups wiki" in the ".moewiki_content" "css_element"
    And I press "Save changes"
    And I log out
    Given I log in as "student1"
    And I am on homepage
    And I follow "Course 1"
    And I follow "W.WC"
    And I should see "C7 no groups wiki" in the ".moewiki_content" "css_element"
    And I log out
  ...
  Scenario: Separate groups - basic access etc
    ...
    And I follow "Course 1"
    And I turn editing mode on
    And I add a "MOE wiki" to section "1"
    ...
    Then I should see "Viewing wiki for: G2" in the ".ouw_subwiki" "css_element"
    And I should see "C6 separate groups wiki" in the ".moewiki_content" "css_element"
    ...
    And the "Separate groups" select box should contain "G2"
    And I should see "C2 separate groups wiki" in the ".moewiki_content" "css_element"
    ...
    When I press "Save changes"
    # Checking creating sections in an moewiki page
  ...
  Scenario: Visible groups - basic access etc
    ...
    When I press "Go"
    Then "div.singleselect" "css_element" should exist
    And I should see "C3 visible groups wiki" in the ".moewiki_content" "css_element"
    And "Student 1" "link" should exist
    Given I set the field "Visible groups" to "G2"
    When I press "Go"
    Then "Create page" "button" should exist
  ...
  Scenario: Individual - basic access etc
    ...
    When I press "Go"
    Then I should see "C4 individual wiki" in the ".moewiki_content" "css_element"
    And "Student 1" "link" should exist
    # unable to check for date
    And I log out
    ...
    When I press "Go"
    Then I should see "C5 individual wiki" in the ".moewiki_content" "css_element"
    And "Student 2" "link" should exist
    And I am on homepage
    And I follow "Course 1"
    And I follow "W.I"
  ...
  Scenario: Wiki history No groups -
    ...
    And I press "Save changes"
    # Confirm start page set up
    Then I should see "C23 no groups wiki" in the ".moewiki_content" "css_element"
    And "Teacher 1" "link" should exist
    # unable to check for date
    And I add a moewiki page with the following data:
    ...
    And I add a moewiki page with the following data:
        ...
        | Content | C23 |
    And I edit a moewiki page with the following data:
    ...
    When I edit a moewiki page with the following data:
      | Content | MISCHIEF |
    ...
    Then I edit a moewiki page with the following data:
      | Content | PORNOGRAPHY |
    And I log out
  ...
  Scenario: Attachments No groups
    ...
    And I press "Save changes"
    # Confirm start page set up
    Then I should see "C71 no groups wiki" in the ".moewiki_content" "css_element"
    And "Teacher 1" "link" should exist
    # unable to check for date
    And I add a moewiki page with the following data:
    ...
    And "span.moewiki-annotation-marker" "css_element" should exist
    ...
    When I click on "span.moewiki-annotation-tag:nth-of-type(1)" "css_element"
    Then I should see "web"
    And I should see "Teacher 1"
    When I click on "span.moewiki-annotation-tag:nth-of-type(2)" "css_element"
    ...
    Then "span.moewiki-annotation-tag:nth-of-type(2)" "css_element" should be visible
    And "span.moewiki-annotation-tag:nth-of-type(1)" "css_element" should be visible
