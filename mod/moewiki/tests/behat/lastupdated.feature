@ou @ou_vle @mod @mod_moewiki @lastmodified
Feature: Show last updated information on activity link
  ...
  Scenario: No groups - basic test etc
    ...
    And ".lastmodtext.moewikilmt" "css_element" should not exist
    Given I follow "W.WC"
    ...
    Then ".lastmodtext.moewikilmt" "css_element" should exist
  ...
  Scenario: Group wikis
    ...
    And I follow "Course 1"
    And I turn editing mode on
    And I add a "MOE wiki" to section "1" and I fill the form with:
        | Name | W.SG |
        | Description | Separate groups |
        | Sub-wikis | One wiki per group |
        | Group mode | Separate groups |
    And I add a "MOE wiki" to section "2" and I fill the form with:
        | Name | W.VG |
    ...
    And I am on site homepage
    When I follow "Course 1"
    Then "/descendant::div[@class='activityinstance'][1]//span[@class='lastmodtext moewikilmt']" "xpath_element" should not exist
    And "/descendant::div[@class='activityinstance'][2]//span[@class='lastmodtext moewikilmt']" "xpath_element" should not exist
    Given I follow "W.SG"
    And I press "Create page"
    ...
    And I press "Save changes"
    And I follow "Course 1"
    Then "/descendant::div[@class='activityinstance'][1]//span[@class='lastmodtext moewikilmt']" "xpath_element" should exist
    And "/descendant::div[@class='activityinstance'][2]//span[@class='lastmodtext moewikilmt']" "xpath_element" should exist
    And I log out
