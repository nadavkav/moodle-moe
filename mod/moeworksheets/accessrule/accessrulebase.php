...
/**
 * Base class for rules that restrict the ability to attempt a moeworksheets.
 *
...
/**
 * A base class that defines the interface for the various moeworksheets access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class moeworksheets_access_rule_base {
    /** @var stdClass the moeworksheets settings. */
    protected $moeworksheets;
    /** @var moeworksheets the moeworksheets object. */
    protected $moeworksheetsobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular moeworksheets.
     * @param moeworksheets $moeworksheetsobj information about the moeworksheets in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($moeworksheetsobj, $timenow) {
        $this->moeworksheetsobj = $moeworksheetsobj;
        $this->moeworksheets = $moeworksheetsobj->get_moeworksheets();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given moeworksheets, otherwise return null.
     * @param moeworksheets $moeworksheetsobj information about the moeworksheets in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/moeworksheets:ignoretimelimits capability.
     * @return moeworksheets_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_moeworksheets_preflight_check_form $moeworksheetsform the form being built.
    ...
    /**
     * This is called when the current attempt at the moeworksheets is finished. This is
    ...
    /**
     * Information, such as might be shown on the moeworksheets view page, relating to this restriction.
     ...
     * this moeworksheets, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the moeworksheets settings form. This
     * method is called from {@link mod_moeworksheets_mod_form::definition()}, while the
    ...
    /**
     * @return array key => lang string any choices to add to the moeworksheets Browser
    ...
    /**
     * Save any submitted settings when the moeworksheets settings form is submitted. This
     * is called from {@link moeworksheets_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the moeworksheets is deleted. This is called
     * from {@link moeworksheets_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link moeworksheets_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $moeworksheetsid the id of the moeworksheets we are loading settings for. This
     *     can also be accessed as moeworksheets.id in the SQL. (moeworksheets is a table alisas for {moeworksheets}.)
     ...
     */
    public static function get_extra_settings($moeworksheetsid) {
        return array();
    }
}
