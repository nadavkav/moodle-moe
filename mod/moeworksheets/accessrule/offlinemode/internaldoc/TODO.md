...
1.  DONE Clone moeworksheetsaccess_honestycheck as a starting point.
...
7.  DONE Callback to get the setting on the moeworksheets form & save it.
...
14. DONE Our own attempt.php script, that displays all the quetsions in the moeworksheets, in different divs.
...
20. INTEGRATED (MDL-48410) Better Behat steps for adding questions to a moeworksheets.
...
23. DONE Copy moeworksheets autosave locally, so we can edit it.
24. DONE navigation.js should update the pagenumber in the URL.
25. DONE navigation.js should send page number changes to Moodle to update moeworksheets_attempts.currentpage.
...
34. DONE Add a link to the upload script to the moeworksheets infor page.
...
49. INTEGRATED MDL-48666 It's not possible to intentify the rows in the moeworksheets summary table from JS.
...
67. INTEGRATED MDL-48829 class name on moeworksheets nav buttons to indicate which page that question is on.
