...
/**
 * Strings for the moeworksheetsaccess_offlinemode plugin.
 *
...
$string['backtothemoeworksheets'] = 'Back to the moeworksheets';
...
$string['description'] = 'This moeworksheets uses fault-tolerant mode. Adminstrators can {$a}';
...
$string['loggedinaswronguser'] = 'You have logged in with an account other than the one that was attempting the moeworksheets. That will not work. Click Continue to login again as the right user.';
...
$string['offlinemodeenabled_desc'] = 'Whether the fault-tolerant mode should be enabled by default for new moeworksheetszes, and also whether it should be an advanced settings (behind \'Show more ...\') on the moeworksheets settings form.';
$string['offlinemodeenabled_help'] = 'The goal of this experimental option is to let students attempt a moeworksheets even if the network connection is not reliable. For example on a train going through tunnels, or just with bad wi-fi. The students can move between pages of the moeworksheets even if the server is not avaialble, and all their answers are stored locally, and sent to the server when possible.';
$string['offlinemode:uploadresponses'] = 'Upload responses';
$string['pluginname'] = 'moeworksheets fault-tolerant mode';
...
$string['responsefiles_help'] = 'You can upload one or more response files downloaded using the \'Emergency response export\' link during a moeworksheets attempt.';
