YUI.add('moodle-moeworksheetsaccess_offlinemode-download', function (Y, NAME) {
 ...
 *
 * @module moodle-moeworksheetsaccess_offlinemode-download
 */

/**
 * Provide a download link to save all the current responses to a file.
 *
 * @class M.moeworksheetsaccess_offlinemode.download
 */

M.moeworksheetsaccess_offlinemode = M.moeworksheetsaccess_offlinemode || {};
M.moeworksheetsaccess_offlinemode.download = {
    /**
     ...
     */
    SELECTORS: {
        DOWNLOAD_CONFIRM_MESSAGE: '#moeworksheets-download-confirm-message',
    ...
    init: function(filename, publicKey) {
        ...
        if (!this.form) {
            Y.log('No response form found. Why did you try to set up download?', 'debug', 'moodle-moeworksheetsaccess_offlinemode-download');
            return;
        }
    ...
    showDownloadMessage: function(container) {
        ...
        now = new Date();
        container.append('<p id="moeworksheets-download-confirm-message">' +
                M.util.get_string('lastsavedtothiscomputer', 'moeworksheetsaccess_offlinemode',
    ...
    "requires": [
        ...
        "json",
        "io-form",
        "moodle-moeworksheetsaccess_offlinemode-jsencrypt",
        "moodle-moeworksheetsaccess_offlinemode-sjcl"
    ]
});
