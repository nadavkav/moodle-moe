...
class content_load extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform =& $this->_form;
        $mform->addElement('header', 'categoryheader', get_string('loadcontent', 'moeworksheets'));
        $mform->addElement('text', 'additionalcontentname', get_string('additionalcontentname', 'moeworksheets'));
    ...
    public function add_action_buttons($cancel = true, $submitlabel = null) {
        ...
        if ($cancel) {
            ...
            $buttonarray[] = &$mform->createElement('button', 'preview', get_string('saveandpreview', 'mod_moeworksheets'));
