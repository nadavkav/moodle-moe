...
/**
 * Strings for component 'moeworksheets', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the moeworksheets. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the moeworksheets. This means that different students are likely to get a different selection of questions, and when a moeworksheets allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addarandomselectedquestion'] = 'Add a random selected question ...';
$string['adddescriptionlabel'] = 'Add a description item';
$string['additionalcontent'] = 'Additional contents';
$string['additionalcontentedit'] = 'Add content';
$string['additionalcontentlist'] = 'Additional content list';
$string['additionalcontentname'] = 'Presentation Name';
$string['addingquestion'] = 'Adding a question';
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any moeworksheets in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your moeworksheets over on the other side of this page.</p>';
...
$string['addquestionstomoeworksheets'] = 'Add questions to current moeworksheets';
...
$string['addrandomquestiontomoeworksheets'] = 'Add a random question to moeworksheets {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstomoeworksheets'] = 'Add selected questions to the moeworksheets';
$string['addselectedtomoeworksheets'] = 'Add selected to moeworksheets';
$string['addtomoeworksheets'] = 'Add to moeworksheets';
...
$string['attempterror'] = 'You are not allowed to attempt this moeworksheets at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptmoeworksheetsnow'] = 'Attempt moeworksheets now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'moeworksheets attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during moeworksheets attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtomoeworksheets'] = 'Back to moeworksheets editing';
$string['basicideasofmoeworksheets'] = 'The basic ideas of moeworksheets-making';
...
* The moeworksheets will only start if the student has a JavaScript-enabled web-browser
* The moeworksheets appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['contentlist'] = 'Content List';
$string['cannotcreatepath'] = 'Path cannot be created ({$a})';
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this moeworksheets has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the moeworksheets';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this moeworksheets. The moeworksheets is set to be graded out of {$a->grade}, but none of the questions in the moeworksheets have a grade. This can be fixed on the \'Edit quiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this moeworksheets. The moeworksheets definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this moeworksheets. The moeworksheets has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire moeworksheets attempt and start another one. This option is mainly useful for practice moeworksheetszes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire moeworksheets attempt and start another one. This option is mainly useful for practice moeworksheetszes.
...
$string['closebeforeopen'] = 'Could not update the moeworksheets. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark moeworksheets complete when the student has exhausted the maximum number of attempts.';
$string['connectcontent'] = 'Connect content to page {$a}';
$string['contentlistdesc'] = 'Please chose one content to edit';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the moeworksheets.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the moeworksheets.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the moeworksheets.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a moeworksheets after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the moeworksheets.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new moeworksheets. You can also configure which moeworksheets settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the moeworksheets grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the moeworksheets page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the moeworksheets editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during moeworksheets attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the moeworksheets.';
$string['configrequiresubnet'] = 'Students can only attempt the moeworksheets from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a moeworksheets attempt or look at the moeworksheets reports.';
$string['configshowblocks'] = 'Show blocks during moeworksheets attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this moeworksheets, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for moeworksheetszes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for moeworksheetszes in seconds. 0 mean no time limit.';
...
$string['continueattemptmoeworksheets'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The moeworksheets is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The moeworksheets will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to moeworksheets';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the moeworksheets.';
$string['csseditor'] = 'CSS Editor';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the moeworksheets a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the moeworksheets a second time.';
...
$string['deletecontent'] = 'Delete Addition content';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/moeworksheets folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new moeworksheets attempt will contain the results of the previous attempt. This allows a moeworksheets to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editcontent'] = 'Edit content';
$string['editingquestion'] = 'Editing a question';
$string['editingmoeworksheets'] = 'Editing moeworksheets';
$string['editingmoeworksheets_help'] = 'When creating a moeworksheets, the main concepts are:

* The moeworksheets, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the moeworksheets and different students can get different questions';
$string['editingmoeworksheets_link'] = 'mod/moeworksheets/edit';
$string['editingmoeworksheetsx'] = 'Editing moeworksheets: {$a}';
...
$string['editmoeworksheets'] = 'Edit quiz';
$string['editmoeworksheetsquestions'] = 'Edit quiz questions';
$string['editsubject'] = 'Add Subject';
...
You can access this moeworksheets at {$a->moeworksheetsurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->moeworksheetsname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->moeworksheetsname}';
$string['emailnotifybody'] = 'Dear {$a->username},

{$a->studentname} has completed
\'{$a->moeworksheetsname}\' ({$a->moeworksheetsurl})
in course \'{$a->coursename}\'

You can review this attempt at {$a->moeworksheetsreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->moeworksheetsname}. See {$a->moeworksheetsreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->moeworksheetsname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->moeworksheetsname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->moeworksheetsname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->moeworksheetsname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'moeworksheets attempt deleted';
$string['eventattemptpreviewstarted'] = 'moeworksheets attempt preview started';
$string['eventattemptreviewed'] = 'moeworksheets attempt reviewed';
$string['eventattemptsummaryviewed'] = 'moeworksheets attempt summary viewed';
$string['eventattemptviewed'] = 'moeworksheets attempt viewed';
$string['eventeditpageviewed'] = 'moeworksheets edit page viewed';
$string['eventoverridecreated'] = 'moeworksheets override created';
$string['eventoverridedeleted'] = 'moeworksheets override deleted';
$string['eventoverrideupdated'] = 'moeworksheets override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventmoeworksheetsattemptabandoned'] = 'moeworksheets attempt abandoned';
$string['eventmoeworksheetsattempttimelimitexceeded'] = 'moeworksheets attempt time limit exceeded';
$string['eventmoeworksheetsattemptstarted'] = 'moeworksheets attempt started';
$string['eventmoeworksheetsattemptsubmitted'] = 'moeworksheets attempt submitted';
$string['eventreportviewed'] = 'moeworksheets report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the moeworksheets. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the moeworksheets when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the moeworksheets. You have to make a trade-off based on how much you trust the performance of your server during moeworksheetszes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final moeworksheets grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'moeworksheets grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->moeworksheetsgrade}.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt moeworksheetszes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a moeworksheets.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the moeworksheets';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new moeworksheets, provide this many blank overall feedback boxes. Once the moeworksheets has been created, the form shows the number of fields required for the number of feedbacks in the moeworksheets. The setting must be at least 1.';
...
$string['invalidmoeworksheetsid'] = 'Invalid moeworksheets ID';
...
$string['javascriptapp'] = 'HTML5+CSS+javascript application';
$string['javascripteditor'] = 'Javascript Editor';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in moeworksheets';
$string['listsubject'] = 'List of subjects';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->moeworksheets} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your moeworksheets attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own moeworksheets submissions';
$string['messageprovider:submission'] = 'Notification of moeworksheets submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'moeworksheets';
$string['modulename_help'] = 'The moeworksheets activity enables a teacher to create moeworksheetszes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the moeworksheets to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/moeworksheets/view';
$string['modulenameplural'] = 'moeworksheetszes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the moeworksheets in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the moeworksheets';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer moeworksheetszes it makes sense to stretch the moeworksheets over several pages by limiting the number of questions per page. When adding questions to the moeworksheets, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['nextquestiongroup'] = 'Next question group';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this moeworksheets';
...
$string['nogradewarning'] = 'This moeworksheets is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the moeworksheets settings.';
...
$string['noquestionsinmoeworksheets'] = 'There are no questions in this moeworksheets.';
...
$string['noreview'] = 'You are not allowed to review this moeworksheets';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this moeworksheets until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This moeworksheets is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the moeworksheets module. As a work around, set a time limit for the whole moeworksheets. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this moeworksheets';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this moeworksheets';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'moeworksheets open and close dates updated';
...
$string['orderingmoeworksheets'] = 'Order and paging';
$string['orderingmoeworksheetsx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a moeworksheets has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the moeworksheets before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their moeworksheets attempt before time expires. If the student is actively working on the moeworksheets at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/moeworksheets/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this moeworksheets to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->moeworksheets} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->moeworksheets} - Override';
$string['pageshort'] = 'P';
$string['page-mod-moeworksheets-x'] = 'Any moeworksheets module page';
$string['page-mod-moeworksheets-attempt'] = 'Attempt moeworksheets page';
$string['page-mod-moeworksheets-edit'] = 'Edit quiz page';
$string['page-mod-moeworksheets-report'] = 'Any moeworksheets report page';
$string['page-mod-moeworksheets-review'] = 'Review moeworksheets attempt page';
$string['page-mod-moeworksheets-summary'] = 'moeworksheets attempt summary page';
$string['page-mod-moeworksheets-view'] = 'moeworksheets information page';
...
$string['pluginadministration'] = 'moeworksheets administration';
$string['pluginname'] = 'moeworksheets';
$string['popup'] = 'Show moeworksheets in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the moeworksheets in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this moeworksheets in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['prevquestiongroup'] = 'Previews question group';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewmoeworksheets'] = 'Preview {$a}';
$string['previewmoeworksheetsnow'] = 'Preview moeworksheets now';
...
$string['contentquestions'] = "Content's Questions";
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->moeworksheetsnames}<br />The question will not be deleted from these moeworksheetszes but only from the category list.';
...
$string['questionsinthismoeworksheets'] = 'Questions in this moeworksheets';
...
$string['moeworksheets:addinstance'] = 'Add a new moeworksheets';
$string['moeworksheets:attempt'] = 'Attempt moeworksheetszes';
$string['moeworksheetsavailable'] = 'The moeworksheets is available until: {$a}';
$string['moeworksheetsclose'] = 'Close the moeworksheets';
$string['moeworksheetsclosed'] = 'This moeworksheets closed on {$a}';
$string['moeworksheetscloses'] = 'moeworksheets closes';
$string['moeworksheetscloseson'] = 'This moeworksheets will close at {$a}';
$string['moeworksheets:deleteattempts'] = 'Delete moeworksheets attempts';
$string['moeworksheets:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['moeworksheets:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['moeworksheets:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['moeworksheets:grade'] = 'Grade moeworksheetszes manually';
$string['moeworksheets:ignoretimelimits'] = 'Ignores time limit on moeworksheetszes';
$string['moeworksheetsisclosed'] = 'This moeworksheets is closed';
$string['moeworksheetsisopen'] = 'This quiz is open';
$string['moeworksheetsisclosedwillopen'] = 'moeworksheets closed (opens {$a})';
$string['moeworksheetsisopenwillclose'] = 'moeworksheets open (closes {$a})';
$string['moeworksheets:manage'] = 'Manage moeworksheetszes';
$string['moeworksheets:manageoverrides'] = 'Manage moeworksheets overrides';
$string['moeworksheetsnavigation'] = 'moeworksheets navigation';
$string['moeworksheetsopen'] = 'Open the moeworksheets';
$string['moeworksheetsopenclose'] = 'Open and close dates';
$string['moeworksheetsopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['moeworksheetsopenclose_link'] = 'mod/moeworksheets/timing';
$string['moeworksheetsopened'] = 'This moeworksheets is open.';
$string['moeworksheetsopenedon'] = 'This moeworksheets opened at {$a}';
$string['moeworksheetsopens'] = 'moeworksheets opens';
$string['moeworksheetsopenwillclose'] = 'This moeworksheets is open, will close on {$a} at';
$string['moeworksheetsordernotrandom'] = 'Order of moeworksheets not shuffled';
$string['moeworksheetsorderrandom'] = '* Order of moeworksheets is shuffled';
$string['moeworksheets:preview'] = 'Preview moeworksheetszes';
$string['moeworksheets:regrade'] = 'Regrade moeworksheets attempts';
$string['moeworksheets:reviewmyattempts'] = 'Review your own attempts';
$string['moeworksheetssettings'] = 'moeworksheets settings';
$string['moeworksheets:view'] = 'View moeworksheets information';
$string['moeworksheets:viewreports'] = 'View moeworksheets reports';
$string['moeworksheetstimer'] = 'moeworksheets Timer';
$string['moeworksheetswillopen'] = 'This moeworksheets will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole moeworksheets to be graded.  Are you sure you want to continue?';
$string['reattemptmoeworksheets'] = 'Re-attempt moeworksheets';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this moeworksheets';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingmoeworksheets'] = 'Regrading moeworksheets "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallmoeworksheetsattempts'] = 'Delete all moeworksheets attempts';
...
$string['reportusersall'] = 'all users who have attempted the moeworksheets';
$string['reportuserswith'] = 'enrolled users who have attempted the moeworksheets';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the moeworksheets';
$string['reportuserswithout'] = 'enrolled users who have not attempted the moeworksheets';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the moeworksheets.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'moeworksheets access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) moeworksheets, to ensure that only people in a certain location can access the moeworksheets.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to moeworksheets defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after moeworksheets is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while moeworksheets is open';
$string['reviewclosed'] = 'After the moeworksheets is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->moeworksheets} by {$a->user}';
$string['reviewopen'] = 'Later, while the moeworksheets is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a moeworksheets attempt or look at the moeworksheets reports.
...
**Later, while the moeworksheets is still open** settings apply after this, and before the moeworksheets close date.

**After the moeworksheets is closed** settings apply after the moeworksheets close date has passed. If the moeworksheets does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current moeworksheets attempt.';
...
$string['savemoeworksheets'] = 'Save this whole moeworksheets';
...
$string['scormpackage'] = 'SCORM package';
$string['search:activity'] = 'moeworksheets - activity information';
...
$string['selectquestions'] = 'Select question';
...
$string['showblocks'] = 'Show blocks during moeworksheets attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during moeworksheets attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the moeworksheets is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the moeworksheets, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonmoeworksheets'] = 'Specified question is not on the specified moeworksheets';
...
$string['subneterror'] = 'Sorry, this moeworksheets has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this moeworksheets.';
$string['subnetnotice'] = 'This moeworksheets has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_moeworksheets'] = 'Report';
$string['subplugintype_moeworksheets_plural'] = 'Reports';
$string['subplugintype_moeworksheetsaccess'] = 'Access rule';
$string['subplugintype_moeworksheetsaccess_plural'] = 'Access rules';
$string['substitutedby'] = 'will be substituted by';
$string['pagesuccessfulsave'] = 'Page successfully saved';
$string['summaryofattempt'] = 'Summary of attempt';
$string['summaryofattempts'] = 'Summary of your previous attempts';
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the moeworksheets.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the moeworksheets since you have not passed the time delay before attempting another moeworksheets';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial moeworksheets page and a countdown timer is displayed in the moeworksheets navigation block.';
$string['timelimit_link'] = 'mod/moeworksheets/timing';
$string['timelimitexeeded'] = 'Sorry! moeworksheets time limit exceeded!';
...
$string['updatesettings'] = 'Update moeworksheets settings';
...
$string['upgradesure'] = '<div>In particular the moeworksheets module will perform an extensive change of the moeworksheets tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingmoeworksheetsattempts'] = 'Upgrading moeworksheets attempts: moeworksheets {$a->done}/{$a->outof} (moeworksheets id {$a->info})';
$string['upgradingveryoldmoeworksheetsattempts'] = 'Upgrading very old moeworksheets attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this moeworksheets';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} moeworksheets attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this moeworksheets';
$string['yourfinalgradeis'] = 'Your final grade for this moeworksheets is {$a}.';
