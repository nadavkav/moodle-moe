...
/**
 * This page deals with processing responses during an attempt at a moeworksheets.
 *
...
if ($status == moeworksheets_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == moeworksheets_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
