...
class mod_moeworksheets_renderer extends plugin_renderer_base {
    ...
    public function review_page(moeworksheets_attempt $attemptobj, $slots, $page, $showall,
        ...
        $context->admin =  has_capability('mod/moewiki:grade', $context2);
     ...
     */
    public function navigation_panel(moeworksheets_nav_panel_base $panel, moeworksheets_attempt $attemptobj, $page) {
    ...
    public function attempt_form($attemptobj, $page, $slots, $id, $nextpage) {
        ...
        $data->draftcontent = addslashes_js($data->draftcontent);
        $data->userid = $USER->id;
        $context2 = context_module::instance($this->page->cm->id);
