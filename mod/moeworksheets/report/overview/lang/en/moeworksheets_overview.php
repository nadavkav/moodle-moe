...
/**
 * Strings for component 'moeworksheets_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this moeworksheets.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this moeworksheets.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the moeworksheets';
$string['optattemptsonly'] = '{$a} who have attempted the moeworksheets';
$string['optnoattemptsonly'] = '{$a} who have not attempted the moeworksheets';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this moeworksheets is {$a}.';
