...
/**
 * Class to store the options for a {@link moeworksheets_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class moeworksheets_overview_options extends mod_moeworksheets_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('moeworksheets_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (moeworksheets_has_grades($this->moeworksheets)) {
            set_user_preference('moeworksheets_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/moeworksheets:regrade', 'mod/moeworksheets:deleteattempts'), context_module::instance($this->cm->id))
