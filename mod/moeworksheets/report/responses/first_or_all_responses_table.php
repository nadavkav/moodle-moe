...
/**
 * This file defines the moeworksheets responses table for showing first or all tries at a question.
 *
...
/**
 * This is a table subclass for displaying the moeworksheets responses report, showing first or all tries.
 *
 * @package   moeworksheets_responses
 * @copyright 2014 The Open University
 * @author    Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class moeworksheets_first_or_all_responses_table extends moeworksheets_last_responses_table {
        ...
        foreach ($this->rawdata as $attempt) {
            ...
            for ($try = 1; $try <= $maxtriesinanyslot; $try++) {
                ...
                if ($try !== $maxtriesinanyslot) {
                    $newtablerow->state = moeworksheets_attempt::IN_PROGRESS;
                }
                $newtablerow->try = $try;
