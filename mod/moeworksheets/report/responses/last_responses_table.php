...
/**
 * This file defines the moeworksheets responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the moeworksheets responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class moeworksheets_last_responses_table extends moeworksheets_attempts_report_table {
     ...
     * @param moeworksheets_responses_options $options
     * @param array $groupstudents
     * @param array $students
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($moeworksheets, $context, $qmsubselect, moeworksheets_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-moeworksheets-report-responses-report', $moeworksheets, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->moeworksheets->id . '&amp;attempt=' .
