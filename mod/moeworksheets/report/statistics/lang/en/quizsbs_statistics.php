...
/**
 * Strings for component 'moeworksheets_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtomoeworksheetsreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for moeworksheets, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for moeworksheets grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the moeworksheets varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this moeworksheets are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a moeworksheets and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
...
$string['moeworksheetsinformation'] = 'moeworksheets information';
$string['moeworksheetsname'] = 'moeworksheets name';
$string['moeworksheetsoverallstatistics'] = 'moeworksheets overall statistics';
$string['moeworksheetsstructureanalysis'] = 'moeworksheets structure analysis';
...
$string['statistics:componentname'] = 'moeworksheets statistics report';
...
$string['statsfor'] = 'moeworksheets statistics (for {$a})';
