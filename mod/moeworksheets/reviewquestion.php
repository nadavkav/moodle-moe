...
$baseurl = new moodle_url('/mod/moeworksheets/reviewquestion.php',
...
$PAGE->set_title(get_string('reviewofquestion', 'moeworksheets', array(
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'moeworksheets'));
        die();
...
// Other attempts at the moeworksheets.
