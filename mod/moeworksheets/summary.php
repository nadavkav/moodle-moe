...
/**
 * This page prints a summary of a moeworksheets attempt before it is submitted.
 *
...
$PAGE->set_url('/mod/moeworksheets/summary.php', array('attempt' => $attemptid));
...
$PAGE->navbar->add(get_string('summaryofattempt', 'moeworksheets'));
