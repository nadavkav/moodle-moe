 ...
 *
 */
class mod_moeworksheets_additionalcontent_testcase extends \advanced_testcase {
    public function test_adding() {
        $this->resetAfterTest(true);
        $additionalcontent = new additional_content();
        $additionalcontent->set_name('test content');
        $additionalcontent->set_moeworksheetsid(1);
        ...
        $this->assertEquals(1, $additionalcontent->get_moeworksheetsid());
    }
}
