...
Feature: Allow students to redo questions in a practice moeworksheets, without starting a whole new attempt
  In order to practice particular skills I am struggling with
  As a student
  I need to be able to redo each question in a moeworksheets as often as necessary without starting a whole new attempt, if my teacher allows it.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | moeworksheets       | moeworksheets 1 | moeworksheets 1 description | C1     | moeworksheets1    | immediatefeedback  | 1                |
  ...
  Scenario: Teachers reviewing can see all the qestions attempted in a slot
    ...
    And I navigate to "Statistics" node in "moeworksheets administration > Results"
    And I follow "TF1"
    And "False" row "Frequency" column of "moeworksheetsresponseanalysis" table should contain "100.00%"
    And "True" row "Frequency" column of "moeworksheetsresponseanalysis" table should contain "0.00%"
    And "[No response]" row "Frequency" column of "moeworksheetsresponseanalysis" table should contain "100.00%"
