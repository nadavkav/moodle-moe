...
Feature: Edit moeworksheets page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    And I should see "This moeworksheets is open"

    # Delete last question in last page. Page contains multiple questions
    When I delete "Question C" in the moeworksheets by clicking the delete icon
    Then I should see "Question A" on moeworksheets page "1"
    And I should see "Question B" on moeworksheets page "1"
    And I should not see "Question C" on moeworksheets page "2"
    ...
    Then I should see "Question B" on moeworksheets page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the moeworksheets by clicking the delete icon
    Then I should see "Question B" on moeworksheets page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on moeworksheets page "2"
  ...
  Scenario: Cannot delete the last question in a section.
    ...
    And moeworksheets "moeworksheets 1" contains the following sections:
      ...
      | Heading 1 | 1         | 1       |
      | Heading 2 | 2         | 1       |
    When I follow "Edit moeworksheets"
  ...
  @javascript
  Scenario: Can delete the last question in a moeworksheets.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And moeworksheets "moeworksheets 1" contains the following questions:
