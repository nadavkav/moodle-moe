...
Feature: Edit moeworksheets page - pagination
  In order to build a moeworksheets laid out in pages the way I want
  As a teacher
  ...
  Scenario: Repaginate questions with N question(s) per page as well as clicking
    ...
    And I should see "Essay 01 new" on moeworksheets page "1"
    And I should see "Essay 02 new" on moeworksheets page "2"
    ...
    And I should see "Essay 01 new" on moeworksheets page "1"
    And I should see "Essay 02 new" on moeworksheets page "2"
    And I should see "Essay 03 new" on moeworksheets page "3"
    ...
    And I press "Go"
    Then I should see "Essay 01 new" on moeworksheets page "1"
    And I should see "Essay 02 new" on moeworksheets page "2"
    And I should see "Essay 03 new" on moeworksheets page "3"

    # Add the forth Essay question in a new page (Page 4).
    When I open the "Page 3" add to moeworksheets menu
    ...
    And I should see "Essay 02 new" on moeworksheets page "2"
    And I should see "Essay 03 new" on moeworksheets page "3"
    And I should see "Essay 04 new" on moeworksheets page "3"

    When I click on the "Add" page break icon after question "Essay 03 new"
    And I should see "Essay 01 new" on moeworksheets page "1"
    And I should see "Essay 02 new" on moeworksheets page "2"
    And I should see "Essay 03 new" on moeworksheets page "3"
    And I should see "Essay 04 new" on moeworksheets page "4"
