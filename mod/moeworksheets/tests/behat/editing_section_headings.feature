...
Feature: Edit moeworksheets page - section headings
  In order to build a moeworksheets laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a moeworksheets with one default section
  ...
  Scenario: Modify the default section headings
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    And I change moeworksheets section heading "" to "This is section one"
 ...
 @javascript
  Scenario: Modify section headings
    ...
    And moeworksheets "moeworksheets 1" contains the following questions:
      ...
      | TF3      | 3    |
      | TF4      | 3    |
    And moeworksheets "moeworksheets 1" contains the following sections:
    ...
    And I follow "Edit moeworksheets"
    And I change moeworksheets section heading "" to "This is section one"
    And I change moeworksheets section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: Set section headings to blanks
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    When I change moeworksheets section heading "Heading 1" to ""
    Then I should not see "Heading 1"
    And I should see "Heading 2"
    And I should see "Heading 3"

    And I change moeworksheets section heading "Heading 2" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
    And I should see "Heading 3"

    And I change moeworksheets section heading "Heading 3" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    And I change moeworksheets section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    And I move "TF5" to "After Question 2" in the moeworksheets by clicking the move icon
    Then I should see "TF5" on moeworksheets page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    And I move "TF1" to "After Question 3" in the moeworksheets by clicking the move icon
    Then I should see "TF1" on moeworksheets page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the moeworksheets.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | moeworksheets       | moeworksheets 1 | moeworksheets 1 description | C1     | moeworksheets1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And I follow "moeworksheets 1"
    And I follow "Edit moeworksheets"
    And I click on shuffle for section "Heading 1" on the moeworksheets edit page
    And I click on shuffle for section "Heading 2" on the moeworksheets edit page
    Then shuffle for section "Heading 1" should be "On" on the moeworksheets edit page
    And shuffle for section "Heading 2" should be "On" on the moeworksheets edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the moeworksheets edit page
    And I click on shuffle for section "Heading 2" on the moeworksheets edit page
    Then shuffle for section "Heading 1" should be "Off" on the moeworksheets edit page
    And shuffle for section "Heading 2" should be "Off" on the moeworksheets edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the moeworksheets edit page
    And shuffle for section "Heading 2" should be "Off" on the moeworksheets edit page
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I open the "Page 2" add to moeworksheets menu
