...
Feature: In order to create a moeworksheets that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit moeworksheets page (even after the moeworksheets has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | moeworksheets       | moeworksheets 1 | C1     | moeworksheets1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I add a "True/False" question to the "moeworksheets 1" moeworksheets with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the moeworksheets settings say it should be.
