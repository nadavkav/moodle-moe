YUI.add('moodle-mod_moeworksheets-moeworksheetsquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in moeworksheets editing page.
 *
...
var CSS = {
        ...
        ADDTOmoeworksheetsCONTAINER: 'td.addtomoeworksheetsaction',
...
Y.extend(POPUP, Y.Base, {
    ...
    create_dialogue: function() {
        ...
        var config = {
            ...
            postmethod: 'form',
            footerContent: null,
            extraClasses: ['mod_moeworksheets_qbank_dialogue']
        };
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_moeworksheets-moeworksheetsquestionbank');
        this.dialogue.bodyNode.append(this.loadingDiv);

        // If to support old IE.
        if (window.history.replaceState) {
            window.history.replaceState(null, '', M.cfg.wwwroot + '/mod/moeworksheets/edit.php' + queryString);
        }

        Y.io(M.cfg.wwwroot + '/mod/moeworksheets/questionbank.ajax.php' + queryString, {
            method: 'GET',
            on: {
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_moeworksheets-moeworksheetsquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_moeworksheets-moeworksheetsquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_moeworksheets-moeworksheetsquestionbank');
    },

    link_clicked: function(e) {
        // Add question to moeworksheets. mofify the URL, then let it work as normal.
        if (e.currentTarget.ancestor(CSS.ADDTOmoeworksheetsCONTAINER)) {
...
M.mod_moeworksheets.moeworksheetsquestionbank = M.mod_moeworksheets.moeworksheetsquestionbank || {};
M.mod_moeworksheets.moeworksheetsquestionbank.init = function() {
    return new POPUP();
};
