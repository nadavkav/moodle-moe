YUI.add('moodle-mod_moeworksheets-moeworksheetsbase', function (Y, NAME) {

/**
 * The moeworksheetsbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_moeworksheets-moeworksheetsbase
 */
var moeworksheetsBASENAME = 'mod_moeworksheets-moeworksheetsbase';

var moeworksheetsBASE = function() {
    moeworksheetsBASE.superclass.constructor.apply(this, arguments);
};
 ...
 * @constructor
 */
Y.extend(moeworksheetsBASE, Y.Base, {
    // Registered Modules
    registermodules : [],
 ...
 */
M.mod_moeworksheets.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_moeworksheets.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
