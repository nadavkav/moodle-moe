YUI.add('moodle-mod_moeworksheets-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in moeworksheets editing page.
 *
...
M.mod_moeworksheets.repaginate = M.mod_moeworksheets.repaginate || {};
M.mod_moeworksheets.repaginate.init = function() {
    return new POPUP();
};
