YUI.add('moodle-mod_moeworksheets-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_moeworksheets-questionchooser'
});

M.mod_moeworksheets = M.mod_moeworksheets || {};
M.mod_moeworksheets.init_questionchooser = function() {
    M.mod_moeworksheets.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_moeworksheets.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_moeworksheets-util", "querystring-parse"]});
