YUI.add('moodle-mod_moeworksheets-randomquestion', function (Y, NAME) {
...
/**
 * Add a random question functionality for a popup in moeworksheets editing page.
 *
...
M.mod_moeworksheets.randomquestion = M.mod_moeworksheets.randomquestion || {};
M.mod_moeworksheets.randomquestion.init = function() {
    return new POPUP();
};
