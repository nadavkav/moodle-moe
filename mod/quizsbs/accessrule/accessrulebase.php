...
/**
 * Base class for rules that restrict the ability to attempt a quizsbs.
 *
 * @package   mod_quizsbs
...
/**
 * A base class that defines the interface for the various quizsbs access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class quizsbs_access_rule_base {
    /** @var stdClass the quizsbs settings. */
    protected $quizsbs;
    /** @var quizsbs the quizsbs object. */
    protected $quizsbsobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular quizsbs.
     * @param quizsbs $quizsbsobj information about the quizsbs in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($quizsbsobj, $timenow) {
        $this->quizsbsobj = $quizsbsobj;
        $this->quizsbs = $quizsbsobj->get_quizsbs();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given quizsbs, otherwise return null.
     * @param quizsbs $quizsbsobj information about the quizsbs in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/quizsbs:ignoretimelimits capability.
     * @return quizsbs_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_quizsbs_preflight_check_form $quizsbsform the form being built.
    ...
    /**
     * This is called when the current attempt at the quizsbs is finished. This is
    ...
    /**
     * Information, such as might be shown on the quizsbs view page, relating to this restriction.
     ...
     * this quizsbs, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the quizsbs settings form. This
     * method is called from {@link mod_quizsbs_mod_form::definition()}, while the
    ...
    /**
     * Save any submitted settings when the quizsbs settings form is submitted. This
     * is called from {@link quizsbs_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the quizsbs is deleted. This is called
     * from {@link quizsbs_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link quizsbs_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $quizsbsid the id of the quizsbs we are loading settings for. This
     *     can also be accessed as quizsbs.id in the SQL. (quizsbs is a table alisas for {quizsbs}.)
     ...
     */
    public static function get_extra_settings($quizsbsid) {
        return array();
    }
}
