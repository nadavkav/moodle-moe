...
1.  DONE Clone quizsbsaccess_honestycheck as a starting point.
...
7.  DONE Callback to get the setting on the quizsbs form & save it.
...
14. DONE Our own attempt.php script, that displays all the quetsions in the quizsbs, in different divs.
...
20. INTEGRATED (MDL-48410) Better Behat steps for adding questions to a quizsbs.
...
23. DONE Copy quizsbs autosave locally, so we can edit it.
24. DONE navigation.js should update the pagenumber in the URL.
25. DONE navigation.js should send page number changes to Moodle to update quizsbs_attempts.currentpage.
...
34. DONE Add a link to the upload script to the quizsbs infor page.
...
49. INTEGRATED MDL-48666 It's not possible to intentify the rows in the quizsbs summary table from JS.
...
67. INTEGRATED MDL-48829 class name on quizsbs nav buttons to indicate which page that question is on.
