...
/**
 * Strings for the quizsbsaccess_offlinemode plugin.
 *
...
$string['backtothequizsbs'] = 'Back to the quizsbs';
...
$string['description'] = 'This quizsbs uses fault-tolerant mode. Adminstrators can {$a}';
...
$string['loggedinaswronguser'] = 'You have logged in with an account other than the one that was attempting the quizsbs. That will not work. Click Continue to login again as the right user.';
...
$string['offlinemodeenabled_desc'] = 'Whether the fault-tolerant mode should be enabled by default for new quizsbszes, and also whether it should be an advanced settings (behind \'Show more ...\') on the quizsbs settings form.';
$string['offlinemodeenabled_help'] = 'The goal of this experimental option is to let students attempt a quizsbs even if the network connection is not reliable. For example on a train going through tunnels, or just with bad wi-fi. The students can move between pages of the quizsbs even if the server is not avaialble, and all their answers are stored locally, and sent to the server when possible.';
$string['offlinemode:uploadresponses'] = 'Upload responses';
$string['pluginname'] = 'quizsbs fault-tolerant mode';
...
$string['responsefiles_help'] = 'You can upload one or more response files downloaded using the \'Emergency response export\' link during a quizsbs attempt.';
