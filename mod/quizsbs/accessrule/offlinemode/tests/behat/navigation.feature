...
Feature: Fault-tolerant mode navigation without page reloads
  ...
  As a student
  I need to be able to navigate between pages of the quizsbs without a page reload.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizsbs       | quizsbs fault-tolerant | C1     | quizsbs1    | 1                | 1                   |
  ...
  @javascript
  Scenario: Start a quizsbs attempt and verify that switching to page 2 works.
    When I press "Attempt quizsbs now"
    And I start watching to see if a new page loads
    And I click on "Question 2" "link" in the "quizsbs navigation" "block"
  ...
  @javascript
  Scenario: Start a quizsbs attempt and verify that switching from the summary works.
    When I press "Attempt quizsbs now"
    And I start watching to see if a new page loads
    And I click on "Finish attempt ..." "link" in the "quizsbs navigation" "block"
    And I click on "3" "link" in the "quizsbssummaryofattempt" "table"
    Then I should not see "Answer me A"
    And I should not see "Answer me B"
    ...
    And "#quizsbsnavbutton2" "css_element" should exist
    And "#quizsbsnavbutton2.thispage" "css_element" should not exist
    And "#quizsbsnavbutton3.thispage" "css_element" should exist
    And a new page should not have loaded since I started watching
    # Now successfully navigate away, or the following test will fail.
    And I click on "Miscellaneous" "link" confirming the dialogue
