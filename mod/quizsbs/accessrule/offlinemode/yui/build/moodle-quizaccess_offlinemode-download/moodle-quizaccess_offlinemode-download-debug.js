YUI.add('moodle-quizsbsaccess_offlinemode-download', function (Y, NAME) {
 ...
 *
 * @module moodle-quizsbsaccess_offlinemode-download
 */

/**
 * Provide a download link to save all the current responses to a file.
 *
 * @class M.quizsbsaccess_offlinemode.download
 */

M.quizsbsaccess_offlinemode = M.quizsbsaccess_offlinemode || {};
M.quizsbsaccess_offlinemode.download = {
    /**
     ...
     */
    SELECTORS: {
        DOWNLOAD_CONFIRM_MESSAGE: '#quizsbs-download-confirm-message',
    ...
    init: function(filename, publicKey) {
        ...
        if (!this.form) {
            Y.log('No response form found. Why did you try to set up download?', 'debug', 'moodle-quizsbsaccess_offlinemode-download');
            return;
        }
    ...
    showDownloadMessage: function(container) {
        ...
        now = new Date();
        container.append('<p id="quizsbs-download-confirm-message">' +
                M.util.get_string('lastsavedtothiscomputer', 'quizsbsaccess_offlinemode',
    ...
    "requires": [
        ...
        "json",
        "io-form",
        "moodle-quizsbsaccess_offlinemode-jsencrypt",
        "moodle-quizsbsaccess_offlinemode-sjcl"
    ]
});
