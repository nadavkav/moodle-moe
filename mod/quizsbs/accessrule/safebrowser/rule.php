...
/**
 * Implementaton of the quizsbsaccess_safebrowser plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizsbsaccess_safebrowser extends quizsbs_access_rule_base {

    public static function make(quizsbs $quizsbsobj, $timenow, $canignoretimelimits) {

        if ($quizsbsobj->get_quizsbs()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'quizsbsaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'quizsbsaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'quizsbsaccess_safebrowser'));
    }
}
