...
/**
 * Defines the Moodle forum used to add random questions to the quizsbs.
 *
 * @package   mod_quizsbs
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizsbs_add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'categoryheader',
                get_string('randomfromexistingcategory', 'quizsbs'));
        ...
        $mform->addElement('checkbox', 'includesubcategories', '', get_string('recurse', 'quizsbs'));

        $mform->addElement('select', 'numbertoadd', get_string('randomnumber', 'quizsbs'),
                $this->get_number_of_questions_to_add_choices());

        $mform->addElement('submit', 'existingcategory', get_string('addrandomquestion', 'quizsbs'));

        // Random from a new category section.
        $mform->addElement('header', 'categoryheader',
                get_string('randomquestionusinganewcategory', 'quizsbs'));
        ...
        $mform->addElement('submit', 'newcategory',
                get_string('createcategoryandaddrandomquestion', 'quizsbs'));
