...
/**
 * Defines backup_quizsbs_activity_task class
 *
 * @package     mod_quizsbs
 * @category    backup
...
require_once($CFG->dirroot . '/mod/quizsbs/backup/moodle2/backup_quizsbs_stepslib.php');

/**
 * Provides the steps to perform one complete backup of the quizsbs instance
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_quizsbs_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        // Generate the quizsbs.xml file containing all the quizsbs information
        // and annotating used questions.
        $this->add_step(new backup_quizsbs_activity_structure_step('quizsbs_structure', 'quizsbs.xml'));

        // Note: Following  steps must be present
        // in all the activities using question banks (only quizsbs for now)
