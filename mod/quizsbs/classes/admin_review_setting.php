...
/**
 * Admin settings class for the quizsbs review options.
 *
 * @package   mod_quizsbs
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quizsbs_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_quizsbs_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_quizsbs_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'quizsbs'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'quizsbs'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'quizsbs'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'quizsbs'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'quizsbs'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'quizsbs'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'quizsbs'), $query);
    }
}
