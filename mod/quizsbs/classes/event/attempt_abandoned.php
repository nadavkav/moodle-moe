...
/**
 * The mod_quizsbs attempt abandoned event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int quizsbsid: (optional) id of the quizsbs.
 * }
 *
 * @package    mod_quizsbs
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the quizsbs with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventquizsbsattemptabandoned', 'mod_quizsbs');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizsbs_attempt_abandoned';
    }
