...
/**
 * The mod_quizsbs attempt became overdue event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The quizsbs attempt with id '$this->objectid' belonging to the quizsbs with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventquizsbsattempttimelimitexceeded', 'mod_quizsbs');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizsbs_attempt_overdue';
    }
