...
/**
 * The mod_quizsbs attempt deleted event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_quizsbs');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the quizsbs " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/quizsbs/report.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
