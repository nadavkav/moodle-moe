...
/**
 * The mod_quizsbs attempt preview started event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt preview started event class.
 *
...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_quizsbs');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' previewed by " .
            "the user with id '$this->userid' for the quizsbs with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/quizsbs/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'preview', 'view.php?id=' . $this->contextinstanceid,
