...
/**
 * The mod_quizsbs attempt reviewed event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_quizsbs');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'review', 'review.php?attempt=' . $this->objectid,
