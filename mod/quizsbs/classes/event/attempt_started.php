...
/**
 * The mod_quizsbs attempt started event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt started event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int quizsbsid: (optional) the id of the quizsbs.
 * }
 *
 * @package    mod_quizsbs
 * @since      Moodle 2.6
...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has started the attempt with id '$this->objectid' for the " .
            "quizsbs with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventquizsbsattemptstarted', 'mod_quizsbs');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizsbs_attempt_started';
    }
    ...
    protected function get_legacy_eventdata() {
        $attempt = $this->get_record_snapshot('quizsbs_attempts', $this->objectid);

        $legacyeventdata = new \stdClass();
        $legacyeventdata->component = 'mod_quizsbs';
        ...
        $legacyeventdata->quizsbsid = $attempt->quizsbs;
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'quizsbs', 'attempt', 'review.php?attempt=' . $this->objectid,
            $attempt->quizsbs, $this->contextinstanceid);
    }
