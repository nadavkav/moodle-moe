...
/**
 * The mod_quizsbs attempt submitted event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquizsbsattemptsubmitted', 'mod_quizsbs');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizsbs_attempt_submitted';
    }
