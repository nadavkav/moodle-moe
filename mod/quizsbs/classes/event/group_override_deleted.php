...
/**
 * The mod_quizsbs group override deleted event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs group override deleted event class.
 *
...
class group_override_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridedeleted', 'mod_quizsbs');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the override with id '$this->objectid' for the quizsbs with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/quizsbs/overrides.php', array('cmid' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'delete override', 'overrides.php?cmid=' . $this->contextinstanceid,
