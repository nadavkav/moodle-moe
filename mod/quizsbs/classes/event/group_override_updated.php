...
/**
 * The mod_quizsbs group override updated event.
 *
 * @package    mod_quizsbs
...
/**
 * The mod_quizsbs group override updated event class.
 *
...
class group_override_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverrideupdated', 'mod_quizsbs');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the quizsbs with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'edit override', 'overrideedit.php?id=' . $this->objectid, $this->other['quizsbsid'],
