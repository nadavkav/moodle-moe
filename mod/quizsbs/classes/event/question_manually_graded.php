...
/**
 * The mod_quizsbs question manually graded event.
 *
 * @package    core
...
/**
 * The mod_quizsbs question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_quizsbs');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the attempt " .
            "with id '{$this->other['attemptid']}' for the quizsbs with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/quizsbs/comment.php', array('attempt' => $this->other['attemptid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizsbs', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
            '&slot=' . $this->other['slot'], $this->other['quizsbsid'], $this->contextinstanceid);
    }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'quizsbs_attempts', 'restore' => 'quizsbs_attempt');
