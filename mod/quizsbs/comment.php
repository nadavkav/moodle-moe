...
$PAGE->set_url('/mod/quizsbs/comment.php', array('attempt' => $attemptid, 'slot' => $slot));
...
if (!$attemptobj->is_finished()) {
    print_error('attemptclosed', 'quizsbs');
}

// Check login and permissions.
require_login($attemptobj->get_course(), false, $attemptobj->get_cm());
$attemptobj->require_capability('mod/quizsbs:grade');

// Print the page header.
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('manualgradequestion', 'quizsbs', array(
...
<?php
echo '</form>';
$PAGE->requires->js_init_call('M.mod_quizsbs.init_comment_popup', null, false, quizsbs_get_js_module());
