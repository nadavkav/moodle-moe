...
/**
 * Strings for component 'quizsbs', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_quizsbs
...
$string['accessnoticesheader'] = 'You can preview this quizsbs, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have quizsbszes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the quizsbs. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
...
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your quizsbs over on the other side of this page.</p>';
...
$string['addquestionstoquizsbs'] = 'Add questions to current quizsbs';
...
$string['addrandomquestiontoquizsbs'] = 'Add a random question to quizsbs {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoquizsbs'] = 'Add selected questions to the quizsbs';
$string['addselectedtoquizsbs'] = 'Add selected to quizsbs';
$string['addtoquizsbs'] = 'Add to quizsbs';
...
$string['attempterror'] = 'You are not allowed to attempt this quizsbs at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptquizsbsnow'] = 'Attempt quizsbs now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'quizsbs attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during quizsbs attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back missions';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoquizsbs'] = 'Back to quizsbs editing';
$string['basicideasofquizsbs'] = 'The basic ideas of quizsbs-making';
...
* The quizsbs will only start if the student has a JavaScript-enabled web-browser
* The quizsbs appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this quizsbs has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the quizsbs';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this quizsbs. The quizsbs is set to be graded out of {$a->grade}, but none of the questions in the quizsbs have a grade. This can be fixed on the \'Edit quiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this quizsbs. The quizsbs definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this quizsbs. The quizsbs has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire quizsbs attempt and start another one. This option is mainly useful for practice quizsbszes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire quizsbs attempt and start another one. This option is mainly useful for practice quizsbszes.
...
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the quizsbs.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a quizsbs after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the quizsbs.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new quizsbs. You can also configure which quizsbs settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the quizsbs grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the quizsbs page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the quizsbs editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during quizsbs attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the quizsbs.';
$string['configrequiresubnet'] = 'Students can only attempt the quizsbs from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a quizsbs attempt or look at the quizsbs reports.';
$string['configshowblocks'] = 'Show blocks during quizsbs attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this quizsbs, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for quizsbszes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for quizsbszes in seconds. 0 mean no time limit.';
...
$string['countdownfinished'] = 'The quizsbs is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The quizsbs will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to quizsbs';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the quizsbs.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the quizsbs a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the quizsbs a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/quizsbs folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new quizsbs attempt will contain the results of the previous attempt. This allows a quizsbs to be completed over several attempts.';
...
* The quizsbs, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the quizsbs and different students can get different questions';
$string['editingquizsbs_link'] = 'mod/quizsbs/edit';
$string['editingquizsbsx'] = 'Editing quizsbs: {$a}';
...
$string['editquizsbs'] = 'Edit quiz';
$string['editquizsbsquestions'] = 'Edit quiz questions';
...
You can access this quizsbs at {$a->quizsbsurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->quizsbsname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->quizsbsname}';
$string['emailnotifybody'] = 'Dear {$a->username},

{$a->studentname} has completed
\'{$a->quizsbsname}\' ({$a->quizsbsurl})
in course \'{$a->coursename}\'

You can review this attempt at {$a->quizsbsreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->quizsbsname}. See {$a->quizsbsreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->quizsbsname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->quizsbsname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->quizsbsname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->quizsbsname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'quizsbs attempt deleted';
$string['eventattemptpreviewstarted'] = 'quizsbs attempt preview started';
$string['eventattemptreviewed'] = 'quizsbs attempt reviewed';
$string['eventattemptsummaryviewed'] = 'quizsbs attempt summary viewed';
$string['eventattemptviewed'] = 'quizsbs attempt viewed';
$string['eventeditpageviewed'] = 'quizsbs edit page viewed';
$string['eventoverridecreated'] = 'quizsbs override created';
$string['eventoverridedeleted'] = 'quizsbs override deleted';
$string['eventoverrideupdated'] = 'quizsbs override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventquizsbsattemptabandoned'] = 'quizsbs attempt abandoned';
$string['eventquizsbsattempttimelimitexceeded'] = 'quizsbs attempt time limit exceeded';
$string['eventquizsbsattemptstarted'] = 'quizsbs attempt started';
$string['eventquizsbsattemptsubmitted'] = 'quizsbs attempt submitted';
$string['eventreportviewed'] = 'quizsbs report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the quizsbs. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the quizsbs when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the quizsbs. You have to make a trade-off based on how much you trust the performance of your server during quizsbszes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final quizsbs grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'quizsbs grades deleted';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt quizsbszes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a quizsbs.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the quizsbs';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new quizsbs, provide this many blank overall feedback boxes. Once the quizsbs has been created, the form shows the number of fields required for the number of feedbacks in the quizsbs. The setting must be at least 1.';
...
$string['invalidquizsbsid'] = 'Invalid quizsbs ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in quizsbs';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->quizsbs} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your quizsbs attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own quizsbs submissions';
$string['messageprovider:submission'] = 'Notification of quizsbs submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'quizsbs';
$string['modulename_help'] = 'The quizsbs activity enables a teacher to create quizsbszes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the quizsbs to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/quizsbs/view';
$string['modulenameplural'] = 'quizsbszes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the quizsbs in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the quizsbs';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer quizsbszes it makes sense to stretch the quizsbs over several pages by limiting the number of questions per page. When adding questions to the quizsbs, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this quizsbs';
...
$string['nogradewarning'] = 'This quizsbs is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the quizsbs settings.';
...
$string['noquestionsinquizsbs'] = 'There are no questions in this quizsbs.';
...
$string['noreview'] = 'You are not allowed to review this quizsbs';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this quizsbs until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This quizsbs is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the quizsbs module. As a work around, set a time limit for the whole quizsbs. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this quizsbs';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this quizsbs';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'quizsbs open and close dates updated';
...
$string['orderingquizsbs'] = 'Order and paging';
$string['orderingquizsbsx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a quizsbs has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the quizsbs before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their quizsbs attempt before time expires. If the student is actively working on the quizsbs at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/quizsbs/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this quizsbs to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overrideusereventname'] = '{$a->quizsbs} - Override';
$string['pageshort'] = 'P';
$string['page-mod-quizsbs-x'] = 'Any quizsbs module page';
$string['page-mod-quizsbs-attempt'] = 'Attempt quizsbs page';
$string['page-mod-quizsbs-edit'] = 'Edit quiz page';
$string['page-mod-quizsbs-report'] = 'Any quizsbs report page';
$string['page-mod-quizsbs-review'] = 'Review quizsbs attempt page';
$string['page-mod-quizsbs-summary'] = 'quizsbs attempt summary page';
$string['page-mod-quizsbs-view'] = 'quizsbs information page';
...
$string['pluginadministration'] = 'quizsbs administration';
$string['pluginname'] = 'quizsbs';
$string['popup'] = 'Show quizsbs in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the quizsbs in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this quizsbs in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['prevquestiongroup'] = 'Previews question group';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewquizsbs'] = 'Preview {$a}';
$string['previewquizsbsnow'] = 'Preview quizsbs now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->quizsbsnames}<br />The question will not be deleted from these quizsbszes but only from the category list.';
...
$string['questionsinthisquizsbs'] = 'Questions in this quizsbs';
...
$string['quizsbs:addinstance'] = 'Add a new quizsbs';
$string['quizsbs:attempt'] = 'Attempt quizsbszes';
$string['quizsbsavailable'] = 'The quizsbs is available until: {$a}';
$string['quizsbsclose'] = 'Close the quizsbs';
$string['quizsbsclosed'] = 'This quizsbs closed on {$a}';
$string['quizsbscloses'] = 'quizsbs closes';
$string['quizsbscloseson'] = 'This quizsbs will close at {$a}';
$string['quizsbs:deleteattempts'] = 'Delete quizsbs attempts';
$string['quizsbs:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['quizsbs:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['quizsbs:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['quizsbs:grade'] = 'Grade quizsbszes manually';
$string['quizsbs:ignoretimelimits'] = 'Ignores time limit on quizsbszes';
$string['quizsbsisclosed'] = 'This quizsbs is closed';
$string['quizsbsisopen'] = 'This quiz is open';
$string['quizsbsisclosedwillopen'] = 'quizsbs closed (opens {$a})';
$string['quizsbsisopenwillclose'] = 'quizsbs open (closes {$a})';
$string['quizsbs:manage'] = 'Manage quizsbszes';
$string['quizsbs:manageoverrides'] = 'Manage quizsbs overrides';
$string['quizsbsnavigation'] = 'quizsbs navigation';
$string['quizsbsopen'] = 'Open the quizsbs';
$string['quizsbsopenclose'] = 'Open and close dates';
$string['quizsbsopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['quizsbsopenclose_link'] = 'mod/quizsbs/timing';
$string['quizsbsopened'] = 'This quizsbs is open.';
$string['quizsbsopenedon'] = 'This quizsbs opened at {$a}';
$string['quizsbsopens'] = 'quizsbs opens';
$string['quizsbsopenwillclose'] = 'This quizsbs is open, will close on {$a} at';
$string['quizsbsordernotrandom'] = 'Order of quizsbs not shuffled';
$string['quizsbsorderrandom'] = '* Order of quizsbs is shuffled';
$string['quizsbs:preview'] = 'Preview quizsbszes';
$string['quizsbs:regrade'] = 'Regrade quizsbs attempts';
$string['quizsbs:reviewmyattempts'] = 'Review your own attempts';
$string['quizsbssettings'] = 'quizsbs settings';
$string['quizsbs:view'] = 'View quizsbs information';
$string['quizsbs:viewreports'] = 'View quizsbs reports';
$string['quizsbstimer'] = 'quizsbs Timer';
$string['quizsbswillopen'] = 'This quizsbs will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole quizsbs to be graded.  Are you sure you want to continue?';
$string['reattemptquizsbs'] = 'Re-attempt quizsbs';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this quizsbs';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingquizsbs'] = 'Regrading quizsbs "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallquizsbsattempts'] = 'Delete all quizsbs attempts';
...
$string['reportusersall'] = 'all users who have attempted the quizsbs';
$string['reportuserswith'] = 'enrolled users who have attempted the quizsbs';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the quizsbs';
$string['reportuserswithout'] = 'enrolled users who have not attempted the quizsbs';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the quizsbs.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'quizsbs access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) quizsbs, to ensure that only people in a certain location can access the quizsbs.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to quizsbs defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after quizsbs is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while quizsbs is open';
$string['reviewclosed'] = 'After the quizsbs is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->quizsbs} by {$a->user}';
$string['reviewopen'] = 'Later, while the quizsbs is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a quizsbs attempt or look at the quizsbs reports.
...
**Later, while the quizsbs is still open** settings apply after this, and before the quizsbs close date.

**After the quizsbs is closed** settings apply after the quizsbs close date has passed. If the quizsbs does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current quizsbs attempt.';
...
$string['savequizsbs'] = 'Save this whole quizsbs';
...
$string['search:activity'] = 'quizsbs - activity information';
...
$string['showblocks'] = 'Show blocks during quizsbs attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during quizsbs attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the quizsbs is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the quizsbs, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonquizsbs'] = 'Specified question is not on the specified quizsbs';
...
$string['subplugintype_quizsbs_plural'] = 'Reports';
$string['subplugintype_quizsbsaccess'] = 'Access rule';
$string['subplugintype_quizsbsaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the quizsbs.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the quizsbs since you have not passed the time delay before attempting another quizsbs';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial quizsbs page and a countdown timer is displayed in the quizsbs navigation block.';
$string['timelimit_link'] = 'mod/quizsbs/timing';
$string['timelimitexeeded'] = 'Sorry! quizsbs time limit exceeded!';
...
$string['updatesettings'] = 'Update quizsbs settings';
...
$string['upgradesure'] = '<div>In particular the quizsbs module will perform an extensive change of the quizsbs tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingquizsbsattempts'] = 'Upgrading quizsbs attempts: quizsbs {$a->done}/{$a->outof} (quizsbs id {$a->info})';
$string['upgradingveryoldquizsbsattempts'] = 'Upgrading very old quizsbs attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this quizsbs';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} quizsbs attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this quizsbs';
$string['yourfinalgradeis'] = 'Your final grade for this quizsbs is {$a}.';
