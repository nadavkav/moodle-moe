...
$string['addarandomselectedquestion'] = 'הוספת שאלה אקראית נבחרת...';
$string['addasection'] = 'כותרת חדשה לחלק זה';
...
$string['additionalcontent'] = 'תכנים';
$string['additionalcontentlist'] = 'רשימת תכנים';
$string['additionalcontentedit'] = 'הוספת תוכן';
...
$string['addnewpagesafterselected'] = 'הוספת עמודים חדשים לאחר שאלות נבחרות';
$string['addnewquestionsqbank'] = 'הוספת שאלות לקטגוריה
{$a->catname}: {$a->link}';
$string['addnewuseroverride'] = 'הוספת הגדרות־מותאמות למשתמש';
$string['addpagebreak'] = 'הוספת מעבר עמוד';
$string['addpagehere'] = 'הוספת עמוד';
...
$string['attemptselection'] = 'בחירת נסיונות מענה אותם יש לנתח עבור כל משתמש:';
...
$string['backtocourse'] = 'בחזרה למשימות';
...
$string['contentlist'] = 'רשימת תכנים';
...
$string['cannotstartgradesmismatch'] = 'לא ניתן להתחיל ניסיון מענה בבוחן זה. הבוחן מוגדר ככזה המבוסס על מתן ניקוד למענה נכון על שאלות, כאשר הציון המירבי הוא {$a->grade}.  במצב הנוכחי, אך אף אחת מהשאלות בבוחן אינה מעניקה ניקוד. ניתן לתקן זאת בעמוד \'עריכת שאלות הבוחן\'.';
...
$string['canredoquestions'] = 'לאפשר לענות שוב בתוך אותו נסיון מענה';
$string['canredoquestions_desc'] = 'אם מאופשר, אז מתי שסטודנטים סיימו לענות על שאלה מסויימת, הם יראו את  כפתור "לענות מחדש על השאלה". כפתור זה יאפשר להם לענות על גרסה אחרת של אותה שאלה ללא הצורך להגיש את כל הבוחן ולהתחיל בוחן חדש. אפשרות זו מועילה בעיקר לתרגול בחנים.

אפשרות זו משפיעה רק על שאלות (למשל שאלות מאמר פתוחות) והתנהגויות ( למשל משוב מיידי או אינטרקטיבי עם מספר נסיונות מענה לשאלה) כאשר יש סיכוי שסטודנט יצליח לסיים את המענה על השאלה לפני שנסיון המענה של הבוחן הוגש.';
$string['canredoquestions_help'] = 'אם מאופשר, אז מתי שסטודנטים סיימו לענות על שאלה מסויימת, הם יראו את  כפתור "לענות מחדש על השאלה". כפתור זה יאפשר להם לענות על גרסה אחרת של אותה שאלה ללא הצורך להגיש את כל הבוחן ולהתחיל בוחן חדש. אפשרות זו מועילה בעיקר לתרגול בחנים.

אפשרות זו משפיעה רק על שאלות (למשל שאלות מאמר פתוחות) והתנהגויות ( למשל משוב מיידי או אינטרקטיבי עם מספר נסיונות מענה לשאלה) כאשר יש סיכוי שסטודנט יצליח לסיים את המענה על השאלה לפני שנסיון המענה של הבוחן הוגש.';
$string['canredoquestionsyes'] = 'סטודנטים יכולים לענות שוב על כל שאלה שהסתיימה';
...
$string['completionattemptsexhausted'] = 'או כאשר כל נסיונות המענה הזמינים הושלמו';
$string['completionattemptsexhausted_help'] = 'סימון הבוחן כהושלם כאשר הסטודנט מיצה את המספר המירבי של נסיונות המענה שניתנו לו.';
$string['completionpass'] = 'דרוש ציון עובר';
$string['completionpass_help'] = 'אם מאופשר, פעילות זו תחשב כהושלמה כאשר הסטודנט יקבל \'ציון עובר\', אותו \'ציון עובר\' שהוגדר בגליון הציונים.';
$string['configadaptive'] = 'בחירת \'כן\' תאפשר לסטודנט לענות מספר פעמים לשאלה אפילו באותו נסיון מענה של הבוחן.';
...
$string['configintro'] = 'הערכים שהגדרתם כאן, מגדירים את ערכי בררת־המחדל המופיעים בטופס ההגדרות כאשר יוצרים בוחן חדש. ניתן גם להגדיר אלו הגדרות בוחן נחשבות כמתקדמות (חבויות).';
$string['configmaximumgrade'] = 'ציון בררת־מחדל ממנו יחושב הציון שהתקבל בבוחן.';
...
$string['configtimelimit'] = 'בררת־מחדל להגבלת זמן של בוחן, בדקות. 0 = ללא הגבלת זמן';
$string['configtimelimitsec'] = 'בררת־מחדל להגבלת זמן של בוחן, בשניות. 0 = ללא הגבלת זמן';
...
$string['connectcontent'] = 'חיבור תוכן לעמוד {$a}';
...
$string['defaultgrade'] = 'משקל בררת־מחדל לשאלה';
$string['defaultinfo'] = 'קטגורית בררת־מחדל לשאלות';
...
$string['erroraccessingreport'] = 'גישה לדוח זה לא זמינה';
...
$string['eventattemptdeleted'] = 'נסיונות מענה הבוחן נמחקו';
$string['eventattemptpreviewstarted'] = 'תצוגה מקדימה של נסיון מענה הבוחן החלה';
$string['eventattemptreviewed'] = 'סקירת תוצאות נסיון מענה הבוחן';
$string['eventattemptsummaryviewed'] = 'צפיה בסיכום נסיון מענה הבוחן';
$string['eventattemptviewed'] = 'צפיה בנסיון מענה';
$string['eventeditpageviewed'] = 'עמוד עריכת הבוחן נצפה';
$string['eventoverridecreated'] = 'עקיפת הבוחן נוצרה';
...
$string['feedbackerrorboundaryformat'] = 'גבולות ציון המשוב נדרשים להיות אחוז או מספר. הערך שהוזן בגבול {$a} לא מזוהה.';
...
$string['feedbackerrororder'] = 'על גבולות ציוני המשוב להופיע לפי סדר, כאשר הגבוה ביותר מופיע ראשון. הערך שהוזן בגבול {$a} נמצא מחוץ לרצף.';
$string['file'] = 'קובץ';
...
$string['graceperiod_desc'] = 'כיצד לפעול כאשר הוגדרה האפשרות \'ניתנת תקופת "זמן הארכה" להגשה אך ללא שינוי התגובות\', ערך בררת־מחדל של משך הזמן הנוסף בשניות.';
...
$string['howquestionsbehave_desc'] = 'הגדרות בררת־מחדל לסוג מנגנון השאלות בבוחן';
...
$string['introduction'] = 'הנחיה לבוחן';
...
$string['javascriptapp'] = 'HTML5+CSS+javascript ישום';
$string['javascripteditor'] = 'Javascript עורך';
$string['lastanswer'] = 'התשובה האחרונה שלך הייתה';
$string['layout'] = 'סידור השאלות בבוחן';
$string['layoutasshown'] = 'תצורת עמוד הבוחן כמו שהיא';
...
$string['listsubject'] = 'רשימת נושאים';
...
$string['multipleanswers'] = 'יש לבחור בתשובה אחת לפחות';
$string['mustbesubmittedby'] = 'יש צורך להגיש את נסיון מענה זה';
$string['name'] = 'שם';
$string['navigatenext'] = 'העמוד הבא';
$string['navigateprevious'] = 'העמוד הקודם';
...
$string['nextquestiongroup'] = 'לקבוצת שאלות הבאה';
...
$string['noreviewuntil'] = 'תשובות לבוחן לא זמינות עד למועד {$a}.';
...
$string['notenoughsubquestions'] = 'לא הוגדרו מספיק תת-שאלות!<br />האם לחזור ולתקן שאלה הזו?';
...
$string['overduehandling_desc'] = 'מה יקרה כבררת־מחדל אם סטודנט לא יגיש את הבוחן לפני שזמן הבוחן חלף.';
...
$string['questionbank'] = 'ממאגר השאלות';
...
$string['contentquestions'] = 'שאולות עבור התוכן';
$string['questiondeleted'] = 'השאלה נמחקה. אנא צור קשר עם המורה שלך.';
$string['questiondependencyfree'] = 'אין הגבלה על שאלה זו';
...
$string['randomnumber'] = 'מספר שאלות אקראיות';
...
$string['redoquestion'] = 'לענות מחדש על השאלה';
...
$string['removeselected'] = 'הסרת השאלות הנבחרות';
...
$string['repaginate'] = 'מיספור מחדש של העמודים, כאשר בכל עמוד {$a} שאלות.';
$string['repaginatecommand'] = 'מיספור עמודים מחדש';
...
$string['reportshowonlyfinished'] = 'הצגת נסיון מענה אחד שהסתיים עבור כל משתמש ({$a})';
...
$string['reverttodefaults'] = 'חזרה לבררת־המחדל של הבוחן';
...
$string['search:activity'] = 'בוחן - מידע הפעילות';
$string['sectionheadingedit'] = 'עריכת כותרת \'{$a}\'';
$string['sectionheadingremove'] = 'הסרת כותרת \'{$a}\'';
$string['seequestions'] = '(צפייה בשאלות)';
$string['select'] = 'בחירת';
$string['selectall'] = 'בחירת הכל';
$string['selectcategory'] = 'בחירת קטגוריה';
$string['selectsubject'] = 'בחירת נושא';
$string['selectedattempts'] = 'ניסיונות שנבחרו....';
$string['selectnone'] = 'בטל בחירת הכל';
$string['selectquestions'] = 'בחירת שאלות';
...
$string['shufflequestions_help'] = 'אם דלוק, בכל פעם שמנסים לענות על בוחן זה, סדר השאלות בחלק זה בלבד יעורבב באופן רנדומלי שונה.

הדבר יכול להקשות על סטודנטים לשתף שאלות  באותו חלק של הבוחן , מצד שני זה יקשה על סטודנט לדון על שאלות אלו עם המורה.';
...
$string['singleanswer'] = 'בחירת תשובה אחת';
...
$string['subjectlist'] = 'רשימת נושאים';
$string['subjectname'] = 'שם הנושא';
$string['subjectsuccessfulsave'] = 'נושא נשמר בהצלחה';
...
$string['temporaryblocked'] = 'באופן זמני, לא ניתן לבצע ניסיון מענה נוסף של הבוחן.<br />ניתן יהיה לבצע ניסיון נוסף בתאריך:';
...
$string['timedelay'] = 'לא ניתן לבצע ניסיון מענה של הבוחן מפני שעדיין לא חלפה השהיית הזמן שרק לאחריה ניתן לנסות לענות על הבוחן שוב.';
...
$string['useroverridesdeleted'] = 'ההתאמות המיוחדות של המשתמש נמחקו';
$string['usersnone'] = 'אין לשום תלמיד גישה לבוחן זה';
$string['validate'] = 'אישור תקפות';
$string['viewallanswers'] = 'צפיה ב-{$a} נסיונות מענה';
$string['viewallreports'] = 'צפיה בדוחות עבור {$a} נסיונות מענה';
$string['viewed'] = 'נצפה';
...
$string['wronguse'] = 'לא ניתן להשתמש בעמוד זה בצורה זו';
