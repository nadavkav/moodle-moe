...
/**
 * Strings for component 'quizsbs_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this quizsbs.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this quizsbs.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the quizsbs';
$string['optattemptsonly'] = '{$a} who have attempted the quizsbs';
$string['optnoattemptsonly'] = '{$a} who have not attempted the quizsbs';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this quizsbs is {$a}.';
