...
/**
 * Class to store the options for a {@link quizsbs_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizsbs_overview_options extends mod_quizsbs_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('quizsbs_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (quizsbs_has_grades($this->quizsbs)) {
            set_user_preference('quizsbs_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/quizsbs:regrade', 'mod/quizsbs:deleteattempts'), context_module::instance($this->cm->id))
