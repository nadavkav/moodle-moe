...
/**
 * This file defines the quizsbs responses table for showing first or all tries at a question.
 *
...
/**
 * This is a table subclass for displaying the quizsbs responses report, showing first or all tries.
 *
 * @package   quizsbs_responses
 * @copyright 2014 The Open University
 * @author    Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizsbs_first_or_all_responses_table extends quizsbs_last_responses_table {
        ...
        foreach ($this->rawdata as $attempt) {
            ...
            for ($try = 1; $try <= $maxtriesinanyslot; $try++) {
                ...
                if ($try !== $maxtriesinanyslot) {
                    $newtablerow->state = quizsbs_attempt::IN_PROGRESS;
                }
                $newtablerow->try = $try;
