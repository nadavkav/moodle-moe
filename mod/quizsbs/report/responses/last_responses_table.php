...
/**
 * This file defines the quizsbs responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the quizsbs responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizsbs_last_responses_table extends quizsbs_attempts_report_table {
     ...
     * @param quizsbs_responses_options $options
     * @param array $groupstudents
     * @param array $students
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($quizsbs, $context, $qmsubselect, quizsbs_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-quizsbs-report-responses-report', $quizsbs, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->quizsbs->id . '&amp;attempt=' .
