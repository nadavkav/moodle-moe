...
/**
 * Strings for component 'quizsbs_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtoquizsbsreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for quizsbs, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for quizsbs grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the quizsbs varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this quizsbs are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a quizsbs and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
...
$string['quizsbsinformation'] = 'quizsbs information';
$string['quizsbsname'] = 'quizsbs name';
$string['quizsbsoverallstatistics'] = 'quizsbs overall statistics';
$string['quizsbsstructureanalysis'] = 'quizsbs structure analysis';
...
$string['statistics:componentname'] = 'quizsbs statistics report';
...
$string['statsfor'] = 'quizsbs statistics (for {$a})';
