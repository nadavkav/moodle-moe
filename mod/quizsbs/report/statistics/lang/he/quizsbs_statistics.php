...
/**
 * Strings for component 'quiz_statistics', language 'he', branch 'MOODLE_31_STABLE'
 *
...
$string['backtoquizreport'] = 'בחזרה לדף הראשי של הדו"ח הסטטיסטי.';
...
$string['downloadeverything'] = 'הורדת הדו"ח המלא כ{$a->formatsmenu} {$a->downloadbutton}';
...
$string['facility'] = 'מדד קושי (מספר גבוהה = שאלה "קלה")';
...
$string['statistics:componentname'] = 'דו"ח תוצאות סטטיסטיות של הבוחן';
