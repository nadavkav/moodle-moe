...
/**
 * This page prints a summary of a quizsbs attempt before it is submitted.
 *
 * @package   mod_quizsbs
...
$PAGE->set_url('/mod/quizsbs/summary.php', array('attempt' => $attemptid));
...
$PAGE->navbar->add(get_string('summaryofattempt', 'quizsbs'));
