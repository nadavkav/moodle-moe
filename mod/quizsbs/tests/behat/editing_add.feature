@mod @mod_quizsbs
Feature: Edit quizsbs page - adding things
  In order to build the quizsbs I want my students to attempt
  As a teacher
  I need to be able to add questions to the quizsbs.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizsbs       | quizsbs 1 | quizsbs 1 for testing the Add menu | C1     | quizsbs1    |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I follow "quizsbs 1"
    And I navigate to "Edit quizsbs" node in "quizsbs administration"
    Then I should see "Editing quizsbs: quizsbs 1"

  @javascript
  Scenario: Add some new question to the quizsbs using '+ a new question' options of the 'Add' menu.
    And I open the "last" add to quizsbs menu
    ...
    Then I should see "Editing quizsbs: quizsbs 1"
    And I should see "Essay 01 new" on quizsbs page "1"

    And I open the "Page 1" add to quizsbs menu
    And I follow "a new question"
    And I set the field "qtype_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing quizsbs: quizsbs 1"
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "1"
    ...
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "1"
    And I should see "Essay 03 new" on quizsbs page "1"
    ...
    And I should see "Essay 02 new" on quizsbs page "1"
    And I should see "Essay 03 new" on quizsbs page "1"
    And I should see "Essay 04 new" on quizsbs page "1"
    ...
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "1"
    And I should see "Essay 03 new" on quizsbs page "2"
    And I should see "Essay 04 new" on quizsbs page "2"
    ...
    And I should see "Essay 03 new" on quizsbs page "2"
    And I should see "Essay 04 new" on quizsbs page "2"
    And I should see "Essay for page 2" on quizsbs page "2"

  @javascript
  Scenario: Add questions from question bank to the quizsbs. In order to be able to
      add questions from question bank to the quizsbs, first we create some new questions
    ...
    And I click on "Add to quizsbs" "link" in the "Essay 03" "table_row"
    Then I should see "Editing quizsbs: quizsbs 1"
    And I should see "Essay 03" on quizsbs page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to quizsbs menu
    And I follow "from question bank"
    And I click on "Add to quizsbs" "link" in the "Essay 01" "table_row"
    Then I should see "Editing quizsbs: quizsbs 1"
    And I should see "Essay 03" on quizsbs page "1"
    And I should see "Essay 01" on quizsbs page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to quizsbs" "link" in the "Essay 02" "table_row"
    Then I should see "Editing quizsbs: quizsbs 1"
    And I should see "Essay 03" on quizsbs page "1"
    And I should see "Essay 01" on quizsbs page "1"
    And I should see "Essay 02" on quizsbs page "1"
    ...
    And I should see "Essay 01" on quizsbs page "1"
    And I should see "Essay 02" on quizsbs page "1"
    And I should see "Random" on quizsbs page "1"
    ...
    When I press "Go"
    And I should see "Essay 03" on quizsbs page "1"
    And I should see "Essay 01" on quizsbs page "2"
    And I should see "Essay 02" on quizsbs page "3"
    And I should see "Random" on quizsbs page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to quizsbs menu
    And I follow "a new question" in the open menu
    And I set the field "qtype_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on quizsbs page "3"
    And I should see "Random" on quizsbs page "4"
    And I should see "Essay for page 4" on quizsbs page "4"
