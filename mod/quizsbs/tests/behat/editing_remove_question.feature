@mod @mod_quizsbs
Feature: Edit quizsbs page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    And I should see "This quizsbs is open"

    # Delete last question in last page. Page contains multiple questions
    When I delete "Question C" in the quizsbs by clicking the delete icon
    Then I should see "Question A" on quizsbs page "1"
    And I should see "Question B" on quizsbs page "1"
    And I should not see "Question C" on quizsbs page "2"
    ...
    Then I should see "Question B" on quizsbs page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the quizsbs by clicking the delete icon
    Then I should see "Question B" on quizsbs page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on quizsbs page "2"
  ...
  @javascript
  Scenario: Can delete the last question in a quizsbs.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And quizsbs "quizsbs 1" contains the following questions:
