@mod @mod_quizsbs
Feature: Edit quizsbs page - pagination
  In order to build a quizsbs laid out in pages the way I want
  As a teacher
  ...
  Scenario: Repaginate questions with N question(s) per page as well as clicking
    ...
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "2"
    ...
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "2"
    And I should see "Essay 03 new" on quizsbs page "3"
    ...
    And I press "Go"
    Then I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "2"
    And I should see "Essay 03 new" on quizsbs page "3"

    # Add the forth Essay question in a new page (Page 4).
    When I open the "Page 3" add to quizsbs menu
    ...
    And I should see "Essay 02 new" on quizsbs page "2"
    And I should see "Essay 03 new" on quizsbs page "3"
    And I should see "Essay 04 new" on quizsbs page "3"

    When I click on the "Add" page break icon after question "Essay 03 new"
    And I should see "Essay 01 new" on quizsbs page "1"
    And I should see "Essay 02 new" on quizsbs page "2"
    And I should see "Essay 03 new" on quizsbs page "3"
    And I should see "Essay 04 new" on quizsbs page "4"
