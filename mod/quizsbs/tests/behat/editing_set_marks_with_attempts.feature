@mod @mod_quizsbs
Feature: In order to create a quizsbs that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit quizsbs page (even after the quizsbs has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizsbs       | quizsbs 1 | C1     | quizsbs1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I add a "True/False" question to the "quizsbs 1" quizsbs with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the quizsbs settings say it should be.
