YUI.add('moodle-mod_quizsbs-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in quizsbs editing page.
 *
 * @package   mod_quizsbs
...
M.mod_quizsbs.repaginate = M.mod_quizsbs.repaginate || {};
M.mod_quizsbs.repaginate.init = function() {
    return new POPUP();
};
