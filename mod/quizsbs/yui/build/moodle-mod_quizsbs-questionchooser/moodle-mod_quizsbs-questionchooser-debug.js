YUI.add('moodle-mod_quizsbs-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_quizsbs-questionchooser'
});

M.mod_quizsbs = M.mod_quizsbs || {};
M.mod_quizsbs.init_questionchooser = function() {
    M.mod_quizsbs.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_quizsbs.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_quizsbs-util", "querystring-parse"]});
