YUI.add('moodle-mod_quizsbs-quizsbsbase', function (Y, NAME) {

/**
 * The quizsbsbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_quizsbs-quizsbsbase
 */
var quizsbsBASENAME = 'mod_quizsbs-quizsbsbase';

var quizsbsBASE = function() {
    quizsbsBASE.superclass.constructor.apply(this, arguments);
};
 ...
 */
M.mod_quizsbs.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_quizsbs.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
