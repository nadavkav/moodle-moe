YUI.add('moodle-mod_quizsbs-quizsbsquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in quizsbs editing page.
 *
 * @package   mod_quizsbs
...
var CSS = {
        ...
        ADDTOquizsbsCONTAINER: 'td.addtoquizsbsaction',
...
Y.extend(POPUP, Y.Base, {
    ...
    create_dialogue: function() {
        ...
        var config = {
            ...
            postmethod: 'form',
            footerContent: null,
            extraClasses: ['mod_quizsbs_qbank_dialogue']
        };
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_quizsbs-quizsbsquestionbank');
        this.dialogue.bodyNode.append(this.loadingDiv);

        // If to support old IE.
        if (window.history.replaceState) {
            window.history.replaceState(null, '', M.cfg.wwwroot + '/mod/quizsbs/edit.php' + queryString);
        }

        Y.io(M.cfg.wwwroot + '/mod/quizsbs/questionbank.ajax.php' + queryString, {
            method: 'GET',
            on: {
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_quizsbs-quizsbsquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_quizsbs-quizsbsquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_quizsbs-quizsbsquestionbank');
    },

    link_clicked: function(e) {
        // Add question to quizsbs. mofify the URL, then let it work as normal.
        if (e.currentTarget.ancestor(CSS.ADDTOquizsbsCONTAINER)) {
...
M.mod_quizsbs.quizsbsquestionbank = M.mod_quizsbs.quizsbsquestionbank || {};
M.mod_quizsbs.quizsbsquestionbank.init = function() {
    return new POPUP();
};
