YUI.add('moodle-mod_quizsbs-randomquestion', function (Y, NAME) {
...
/**
 * Add a random question functionality for a popup in quizsbs editing page.
 *
 * @package   mod_quizsbs
...
M.mod_quizsbs.randomquestion = M.mod_quizsbs.randomquestion || {};
M.mod_quizsbs.randomquestion.init = function() {
    return new POPUP();
};
