...
$string['modulename'] = 'לומדה מבוססת xAPI';
$string['modulenameplural'] = 'לומדות מבוססות xAPI';
...
$string['tincanlaunchlrsendpoint'] = 'כתובת האינטרנט של הלומדה';
...
$string['tincanlaunchname'] = 'כותרת הקישור להפעלת הלומדה';
$string['tincanlaunchname_help'] = 'The name of the launch link as it will appear to the user.';

$string['tincanlaunchurl'] = 'כתובת האינטרנט של הלומדה';
...
$string['tincanlaunch'] = 'לומדה מבוססת xAPI';
$string['pluginadministration'] = 'Tin Can Launch Link administration';
$string['pluginname'] = 'לומדה מבוססת xAPI';
...
//View settings
$string['tincanlaunchviewfirstlaunched'] = 'הפעלה ראשונית';
$string['tincanlaunchviewlastlaunched'] = 'הפעלה אחרונה';
$string['tincanlaunchviewlaunchlinkheader'] = 'קישור להפעלת הלומדה';
$string['tincanlaunchviewlaunchlink'] = 'התחלת הלומדה';

$string['tincanlaunch_completed'] = 'תהליך הלימוד הסתיים!';
$string['tincanlaunch_progress'] = 'באמצע תהליך לימוד.';
$string['tincanlaunch_attempt'] = 'ניסיון חדש';
...
// Events
$string['eventactivitylaunched'] = 'הלומדה התחילה';
$string['eventactivitycompleted'] = 'הלומדה הסתיימה';
