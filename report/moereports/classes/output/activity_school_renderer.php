...
class activity_school_renderer extends \plugin_renderer_base {
    ...
    public function display_report($context, $region, $download) {
        ...
        $schoollevelaccess = $DB->get_field('config', 'value', array(
            'name' => 'schools_level_access'
        ));
        ...
        $allcourses = $DB->get_records('course', array(
            'enablecompletion' => '1'
        ));
        ...
        if ($download == "xls") {
            ...
            // assigning by reference gives this: Strict standards:
            // Only variables should be assigned by reference in /data_1/www/html/moodle/moodle/mod/choicegroup/report.php on line 157
