 ...
 * @authors    Nadav Kavalerchik (nadavkav@gmail.com) - RTL & Translation.
...
/* MOE footer LOGOs */
$string['moe_login'] = 'התחברות';
$string['moe_home'] = 'ראשי';
$string['moe_moe'] = 'משרד החינוך';
$string['moe_youtube'] = 'יוטיוב';
$string['moe_facebook'] = 'פייסבוק';
