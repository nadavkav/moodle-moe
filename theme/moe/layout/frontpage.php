...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/moe/style/nojs.css" />
	</noscript>
    <!-- Google web fonts -->
...
<div class="text-center" style="line-height:1em;">
	<img src="<?php echo $CFG->wwwroot;?>/theme/moe/pix/bg/shadow.png" class="slidershadow frontpage-shadow" alt="">
</div>
...
<?php require_once(dirname(__FILE__).'/includes/slideshow.php');?>
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_moe') ?></h4>
            <?php
