 ...
 *
 */
function theme_moe_get_setting($setting, $format = false) {
    global $CFG;
    require_once($CFG->dirroot . '/lib/weblib.php');
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('moe');
    }
...
function theme_moe_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
...
function moe_set_pagewidth1($css, $pagewidth) {
...
function moe_set_pagewidth2($css, $pagewidth) {
...
function moe_set_logo_res($css, $logo_res) {
...
function theme_moe_set_fontsrc($css) {
	global $CFG;
    $tag = '[[setting:fontsrc]]';
	$themewww = $CFG->wwwroot."/theme";
    $css = str_replace($tag, $themewww.'/moe/fonts/', $css);
    return $css;
}

function moe_set_customcss($css, $customcss) {
...
function theme_moe_process_css($css, $theme) {
    ...
    $css = moe_set_pagewidth1($css,$pagewidth);
	$css = moe_set_pagewidth2($css,$pagewidth); 
	$css = moe_set_logo_res($css,$logo_res);
    // Set the Fonts.
    ...
    $css = theme_moe_set_headingfont($css, $headingfont);
    $css = theme_moe_set_bodyfont($css, $bodyfont);
    ...
    $css = moe_set_customcss($css, $customcss);
    ...
    $css = theme_moe_set_maincolor($css, $maincolor);
    ...
    $css = theme_moe_set_mainhovercolor($css, $mainhovercolor);
    ...
    $css = theme_moe_set_linkcolor($css, $linkcolor);
    ...
    $css = theme_moe_set_def_buttoncolor($css, $def_buttoncolor);
    ...
    $css = theme_moe_set_def_buttonhovercolor($css, $def_buttonhovercolor);
    ...
    $css = theme_moe_set_menufirstlevelcolor($css, $menufirstlevelcolor);
    ...
    $css = theme_moe_set_menufirstlevel_linkcolor($css, $menufirstlevel_linkcolor);
    ...
    $css = theme_moe_set_menusecondlevelcolor($css, $menusecondlevelcolor);
    ...
    $css = theme_moe_set_menusecondlevel_linkcolor($css, $menusecondlevel_linkcolor);
    ...
    $css = theme_moe_set_footercolor($css, $footercolor);
    ...
    $css = theme_moe_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_moe_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_moe_set_copyrightcolor($css, $copyrightcolor);
	...
	$css = theme_moe_set_copyright_textcolor($css, $copyright_textcolor);
    ...
    $css = theme_moe_set_socials_color($css, $socials_color);
	...
	if (is_null($theme->setting_file_url('pagebackground', 'pagebackground'))) {
		...
		if ($theme->settings->list_bg==1)  {
			...
			$repeat = 'no-repeat fixed 0 0';
			$size = 'cover';}
		$css = theme_moe_set_pagebackground($css, $pagebackground, $setting);
		$css = theme_moe_set_background_repeat($css, $repeat, $size);
    }
	...
	$css = theme_moe_set_fontsrc($css);
	
    return $css;
}

function theme_moe_set_headingfont($css, $headingfont) {
...
function theme_moe_set_bodyfont($css, $bodyfont) {
...
function theme_moe_set_maincolor($css, $themecolor) {
...
function theme_moe_set_mainhovercolor($css, $themecolor) {
...
function theme_moe_set_linkcolor($css, $themecolor) {
...
function theme_moe_set_def_buttoncolor($css, $themecolor) {
...
function theme_moe_set_def_buttonhovercolor($css, $themecolor) {
...
function theme_moe_set_menufirstlevelcolor($css, $themecolor) {
...
function theme_moe_set_menufirstlevel_linkcolor($css, $themecolor) {
...
function theme_moe_set_menusecondlevelcolor($css, $themecolor) {
...
function theme_moe_set_menusecondlevel_linkcolor($css, $themecolor) {
...
function theme_moe_set_footercolor($css, $themecolor) {
...
function theme_moe_set_footerheadingcolor($css, $themecolor) {
...
function theme_moe_set_footertextcolor($css, $themecolor) {
...
function theme_moe_set_copyrightcolor($css, $themecolor) {
...
function theme_moe_set_copyright_textcolor($css, $themecolor) {
...
function theme_moe_set_socials_color($css, $themecolor) {
...
function theme_moe_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_moe_set_background_repeat($css, $repeat, $size) {
...
function theme_moe_page_init(moodle_page $page) {
    $page->requires->jquery();
	$page->requires->jquery_plugin('jquery.easing.1.3', 'theme_moe'); 
	$page->requires->jquery_plugin('camera_slider', 'theme_moe');
    $page->requires->jquery_plugin('jquery.bxslider', 'theme_moe'); 
}